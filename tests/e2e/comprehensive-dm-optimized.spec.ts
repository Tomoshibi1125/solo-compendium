...
/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║  OPTIMIZED DM COMPLETE TEST - STABLE & RELIABLE VERSION           ║
 * ╠══════════════════════════════════════════════════════════════════╣
  ...
  test('DM Optimized Journey - Stable & Complete', async () => {
    ...
    try {
      ...
      if (await safeNavigate('http://localhost:8080/dm-tools', 'DM Tools Dashboard')) {
        ...
        const dmTools = [
          { path: '/dm-tools/encounter-builder', name: 'Encounter Builder' },
          { path: '/dm-tools/initiative-tracker', name: 'Initiative Tracker' },
