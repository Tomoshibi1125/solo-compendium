...
test.describe.serial('Global App-Wide E2E: DM + Player full functionality', () => {
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // PHASE 1 — DM SESSION
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

  test.describe.serial('Phase 1: DM Session', () => {
    ...
    test.afterAll(async () => {
      if (dmContext) {
        ...
        test.info().attach('dm-final-state', { body: screenshot, contentType: 'image/png' });
    ...
    test('24. Compendium Detail: click entry if available, verify controls', async () => {
      ...
      await compendium.goto();
      await expect(dmPage.getByText('COMPENDIUM').first()).toBeVisible({ timeout: 10_000 });
    });
  ...
  test.describe.serial('Phase 2: Player Session', () => {
    test.beforeAll(async ({ browser }) => {
  ...
  test.describe.serial('Phase 3: Permission Boundaries', () => {
    test.beforeAll(async ({ browser }) => {
  ...
  test.describe.serial('Phase 4: Cross-Context Validation', () => {
    test.beforeAll(async ({ browser }) => {
      dmContext = await browser.newContext();
      dmPage = await dmContext.newPage();
      const auth = new AuthPage(dmPage);
    ...
    test('49. DM campaign detail: verifies page loads after player join', async () => {
      ...
      const detailHeading = dmPage.getByText(/GUILD|CAMPAIGN|OVERVIEW/i).first();
