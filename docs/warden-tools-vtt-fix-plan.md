...
### P1-6 — Initiative auto-roll for monsters (`R14`)

**Problem.** `InitiativeTracker` requires manual init entry for every combatant. DDB Maps + Roll20 + Foundry auto-roll for monster tokens (using monster Dex modifier).
