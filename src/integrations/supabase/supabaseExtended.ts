...
export type FeatureRow = Database['public']['Tables']['character_features']['Row'];
export type PowerRow = Database['public']['Tables']['character_powers']['Row'];
export type ActiveSpellRow = Database['public']['Tables']['character_active_spells']['Row'];
...
export type SpellDurationType = 'rounds' | 'minutes' | 'hours' | 'concentration';
...
export type VTTWeatherType = 'clear' | 'rain' | 'snow' | 'fog' | 'storm' | string;

// ─── Utility Types ──────────────────────────────────────────────────────────────

/** Type-safe helper for JSON column access */
export function asRecord(json: Json | null | undefined): Record<string, unknown> {
...
export function asJsonArray(json: Json | null | undefined): unknown[] {
