...
export type WikiArticle = Database['public']['Tables']['campaign_wiki_articles']['Row'];
export type WikiArticleInsert = Database['public']['Tables']['campaign_wiki_articles']['Insert'];
export type WikiArticleUpdate = Database['public']['Tables']['campaign_wiki_articles']['Update'];
...
export const useCampaignWiki = (campaignId: string | null) => {
    ...
    const addArticle = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['campaign_wiki_articles', campaignId] });
    ...
    const updateArticle = useMutation({
        mutationFn: async ({ id, updates }: { id: string; updates: WikiArticleUpdate }) => {
            const { data, error } = await supabase
                .from('campaign_wiki_articles')
                .update(updates)
                .eq('id', id)
