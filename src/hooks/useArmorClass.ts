...
export function calculateAC(
  ...
  if (!armor || armor.category === 'none') {
    ...
    if (armor.strengthRequirement && strScore && strScore < armor.strengthRequirement) {
      warnings.push(`STR ${strScore} is below ${armor.name}'s requirement of ${armor.strengthRequirement}. Speed reduced by 10 ft.`);
    }
  }
