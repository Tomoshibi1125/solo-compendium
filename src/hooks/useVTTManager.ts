...
export function useVTTManager() {
  ...
  const saveVTTScene = useCallback(async (
    campaignId: string,
  ...
  const loadVTTScene = useCallback(async (
    campaignId: string,
    sceneId?: string
  ): Promise<VTTScene | null> => {
  ...
  const listVTTScenes = useCallback(async (
    campaignId: string
  ): Promise<VTTScene[]> => {
    if (!isSupabaseConfigured) {
      return [];
  ...
  const deleteVTTScene = useCallback(async (
    campaignId: string,
    sceneId: string
  ): Promise<boolean> => {
    if (!user || !isSupabaseConfigured) {
  ...
  const uploadVTTAsset = useCallback(async (
    campaignId: string,
    file: File,
    assetType: 'map' | 'token'
  ...
  const getVTTAssets = useCallback(async (
    campaignId?: string
  ): Promise<VTTAsset[]> => {
    if (!isSupabaseConfigured) {
      return [];
  ...
  const deleteVTTAsset = useCallback(async (
    assetId: string
  ): Promise<boolean> => {
    if (!user || !isSupabaseConfigured) {
