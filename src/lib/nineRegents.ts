 ...
 *
 * Quest-gated, NOT level-gated (Warden/Warden approval required)
 */
		...
		features: [
			{
				...
				description:
					'Immune to ALL damage (magical, physical, psychic, force, etc.). Cannot be moved, grappled, knocked prone, or affected by forced movement. Time Stop/Banishment/Maze fail automatically. Only Wish can bypass (Warden discretion). Attacks bounce off with "IMMUNE" System message.',
				type: "absolute",
			},
			{
	...
	// UNIQUE POWER: White flames that erase evil from existence, purify on cosmic scale
	{
		...
		features: [
			...
			},
			{
				name: "Judgment Day",
				description:
					"Point at creature (no range limit if you can see). PRE save DC 8+prof+PRE or: 20d10 radiant + stunned 10 minutes. On kill: soul judged (Warden decides: paradise/oblivion/hell). UN debates if you have judicial authority.",
				type: "judgment",
			},
		],
		spells: [
