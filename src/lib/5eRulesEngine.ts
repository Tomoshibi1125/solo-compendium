...
export interface Job {
	id: string;
	name: string;
	displayName: string; // Rift Ascendant name
	description: string;
...
// 5e-standard Power (Spell) with Rift Ascendant flavor
...
// 5e-standard Relic (Magic Item) with Rift Ascendant flavor
...
// 5e-standard Character with Rift Ascendant flavor
export interface Character {
	...
	// Standard 5e abilities (displayed with Rift Ascendant names)
	...
	// Rift Ascendant resources (mapped to 5e equivalents)
	riftFavor: {
		current: number;
		max: number;
		dieSize: number;
