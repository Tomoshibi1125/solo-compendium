...
export const SKILLS: Skill[] = [
	...
	},
	{
		...
		name: "Arcana",
		ability: "INT",
		description: "Magical knowledge and System anomalies",
	},
	{
		id: "history",
		name: "History",
...
const SYSTEM_FAVOR_OPTIONS: SystemFavorOption[] = [
	...
	// ── Thematic extras ──
	{
		...
		cost: 1,
		description:
			"The System intervenes — reroll a failed d20 and take either result.",
		rulesText:
			"When you fail an ability check, attack roll, or saving throw, you may spend 1 System Favor to reroll the d20. You must use the new result, even if it is lower.",
		minLevel: 1,
	},
	{
		...
		rulesText:
			"As a bonus action, spend 1 System Favor to end one condition currently affecting you (except unconscious or dead). Alternatively, reduce your exhaustion level by 1.",
		minLevel: 3,
	},
	{
		...
		cost: 2,
		description:
			"The System refuses to let you fall. When reduced to 0 HP, you cling to consciousness.",
		rulesText:
			"When you are reduced to 0 hit points but not killed outright, spend 2 System Favor to drop to 1 HP instead. You can use this after the damage is applied. Usable once per long rest.",
		minLevel: 5,
	},
	{
		...
		cost: 1,
		description:
			"The System reveals hidden information about a creature or object.",
		rulesText:
			"As an action, spend 1 System Favor to learn the AC, current HP percentage (full/bloodied/critical), one damage vulnerability, one damage resistance, or one condition immunity of a creature you can see within 60 feet.",
		minLevel: 1,
	},
	{
		id: "favor-flash-step",
		...
		cost: 1,
		description:
			"The System briefly accelerates your body beyond normal limits.",
		rulesText:
			"As part of your movement on your turn, spend 1 System Favor to teleport up to 10 feet to an unoccupied space you can see. This movement does not provoke opportunity attacks.",
		minLevel: 5,
	},
	{
		...
		rulesText:
			"When you hit with an attack, spend 2 System Favor to turn the hit into a critical hit. Usable once per long rest.",
		minLevel: 9,
	},
	{
		id: "favor-party-link",
		...
		rulesText:
			"As a bonus action, spend 1 System Favor. Until the end of your next turn, you and all allies within 30 feet cannot be surprised, have advantage on initiative rolls, and can communicate telepathically.",
		minLevel: 7,
	},
];
