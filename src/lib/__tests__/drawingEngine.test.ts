...
describe('VTT Drawing Engine', () => {
    ...
    describe('createDrawing', () => {
        it('initializes a drawing with correct fields', () => {
            ...
            const drawing = createDrawing('freehand', points, '#ff0000', 4, 'player1');
    ...
    describe('getTemplateCells', () => {
        it('calculates sphere cells', () => {
            const cells = getTemplateCells({
                id: 't1', type: 'sphere', origin: { x: 50, y: 50 }, radiusFt: 5, color: 'blue', opacity: 0.5
            }, 50);
        ...
        it('calculates cube cells', () => {
            const cells = getTemplateCells({
                id: 't2', type: 'cube', origin: { x: 50, y: 50 }, radiusFt: 10, color: 'red', opacity: 0.5
            }, 50);
