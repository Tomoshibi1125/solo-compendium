...
export const JOB_PROGRESSION_FIXTURES = {
	...
	revenant: {
		// Drain-tank rework: Revenant is now a hybrid half-caster (spells +
		// martial powers/techniques), d8 hit die, half-caster slot progression.
		...
		pathCount: 6,
		pathNames: [
			"Path of the Void Eater",
			"Path of the Black Blood",
			"Path of the Hollow King",
			"Path of the Grave Shepherd",
			"Path of the Dread Veil",
