...
export function validateCharacterImport(json: unknown): CharacterImportValidation {
  ...
  if (typeof json !== 'object' || json === null) {
    return { valid: false, errors: ['Invalid JSON: expected an object'], data: null };
  }
  ...
  const data: CharacterExportSchema = {
    ...
    proficiencies: (obj.proficiencies as CharacterExportSchema['proficiencies']) ?? undefined,
    equipment: Array.isArray(obj.equipment) ? (obj.equipment as CharacterExportSchema['equipment']) : undefined,
    powers: Array.isArray(obj.powers) ? (obj.powers as CharacterExportSchema['powers']) : undefined,
    features: Array.isArray(obj.features) ? (obj.features as CharacterExportSchema['features']) : undefined,
    conditions: Array.isArray(obj.conditions) ? (obj.conditions as string[]) : [],
    exhaustionLevel: typeof obj.exhaustionLevel === 'number' ? obj.exhaustionLevel : 0,
