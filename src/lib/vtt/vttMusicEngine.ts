...
const MOOD_CONFIGS: Record<MusicMood, MoodConfig> = {
	...
	"combat-tension": {
		...
		drones: [98.0, 146.83, 196.0],
		droneType: "sawtooth",
		droneVolume: 0.04,
		texture: true,
		textureFreq: 600,
		textureVolume: 0.03,
		melody: [196, 220, 247, 294, 330, 294, 247, 220],
		melodyDuration: 0.25,
		melodyVolume: 0.03,
		melodyType: "square",
		bpm: 140,
	...
	"boss-epic": {
		...
		textureFreq: 800,
		textureVolume: 0.04,
		melody: [262, 330, 392, 523, 392, 330, 262, 196],
		melodyDuration: 0.3,
		melodyVolume: 0.04,
		melodyType: "square",
		bpm: 160,
	...
	"forest-peaceful": {
		...
		textureFreq: 1200,
		textureVolume: 0.015,
		melody: [523, 587, 659, 784, 659, 587, 523, 440],
		melodyDuration: 1.2,
		melodyVolume: 0.03,
		melodyType: "sine",
		bpm: 60,
	...
	"mystical-wonder": {
		...
		textureFreq: 900,
		textureVolume: 0.02,
		melody: [659, 784, 880, 1047, 880, 784, 659, 523],
		melodyDuration: 1.5,
		melodyVolume: 0.025,
		melodyType: "sine",
		bpm: 50,
	...
	"victory-triumph": {
		...
		textureFreq: 0,
		textureVolume: 0,
		melody: [523, 659, 784, 1047, 784, 1047, 1319, 1047],
		melodyDuration: 0.4,
		melodyVolume: 0.05,
		melodyType: "sine",
		bpm: 120,
	...
	"sadness-loss": {
		...
		textureFreq: 250,
		textureVolume: 0.015,
		melody: [330, 294, 262, 247, 220, 196, 220, 247],
		melodyDuration: 1.0,
		melodyVolume: 0.03,
		melodyType: "sine",
		bpm: 55,
	...
	"desert-heat": {
		...
		textureFreq: 350,
		textureVolume: 0.03,
		melody: [440, 494, 523, 587, 523, 494, 440, 392],
		melodyDuration: 0.9,
		melodyVolume: 0.025,
		melodyType: "triangle",
		bpm: 70,
	...
	"gate-resonance": {
		label: "Gate Resonance (SA)",
		drones: [82.41, 123.47, 164.81],
		droneType: "sine",
		droneVolume: 0.04,
		texture: true,
		textureFreq: 400,
	...
	"monarch-presence": {
		...
		textureFreq: 600,
		textureVolume: 0.03,
		melody: [262, 330, 392, 523, 659, 523, 392, 330],
		melodyDuration: 0.6,
		melodyVolume: 0.04,
		melodyType: "sine",
		bpm: 80,
	...
	"system-awakening": {
		...
		textureFreq: 1000,
		textureVolume: 0.025,
		melody: [523, 659, 784, 1047, 1319, 1047, 784, 659],
		melodyDuration: 0.5,
		melodyVolume: 0.035,
		melodyType: "sine",
		bpm: 100,
...
export class VttMusicEngine {
	...
	static listMoods(): Array<{ id: MusicMood; label: string }> {
		return (Object.entries(MOOD_CONFIGS) as [MusicMood, MoodConfig][]).map(
			([id, c]) => ({
				id,
				label: c.label,
			}),
