...
export function createAmbientSoundZone(
	partial: Partial<AmbientSoundZone> &
		Pick<AmbientSoundZone, "x" | "y" | "audioUrl">,
): AmbientSoundZone {
	return {
...
export const AMBIENT_SOUND_PRESETS: Record<
	string,
	Partial<AmbientSoundZone>
> = {
	...
	dungeon_creak: {
		label: "Dungeon Creaks",
		radius: 10,
		category: "ambient",
		falloff: "linear",
	},
	library: {
		label: "Library Whispers",
		radius: 4,
		category: "ambient",
		falloff: "exponential",
	},
	...
	arena: {
		label: "Arena / Colosseum Crowd",
		radius: 12,
		category: "ambient",
		falloff: "linear",
	},
	workshop: {
		label: "Tinkerer Workshop",
		radius: 4,
		category: "ambient",
		falloff: "exponential",
	},
	clock_tower: {
		label: "Clock Tower Ticking",
		radius: 3,
		category: "ambient",
		falloff: "exponential",
	},
	...
	boss_tension: {
		label: "Boss Encounter Tension",
		radius: 12,
		category: "effect",
		falloff: "linear",
	},
	dimensional_static: {
		label: "Dimensional Static",
		radius: 5,
		category: "effect",
		falloff: "exponential",
	},
	awakening_ceremony: {
		label: "Awakening Ceremony",
		radius: 8,
		category: "effect",
		falloff: "exponential",
	},
	...
	rune_activation: {
		label: "Rune Activation Hum",
		radius: 3,
		category: "effect",
		falloff: "exponential",
	},
	regression_warning: {
		label: "Regression Warning",
		radius: 10,
		category: "effect",
		falloff: "none",
	},
