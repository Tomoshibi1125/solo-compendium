	...
	},
	{
		...
		action: () => {
			...
			const saveButton =
				...
				) as HTMLButtonElement) || findButtonByText("Save");
	...
	// Compendium
	{
		...
		action: () => {
			...
			const favoritesToggle =
				(document.querySelector(
					'input[type="checkbox"][aria-label*="favorite"]',
				) as HTMLElement) || findButtonByText("Favorites");
	...
	// General
	{
		...
		action: () => {
			...
			const closeButton =
				...
				) as HTMLButtonElement) || findButtonByText("Cancel");
	...
	},
	{
		...
		action: () => {
			...
			const helpButton = document.querySelector(
				'button[aria-label*="help"], button[aria-label*="shortcuts"]',
			) as HTMLButtonElement;
			if (helpButton) {
				helpButton.click();
			} else {
