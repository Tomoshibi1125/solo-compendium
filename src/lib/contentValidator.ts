...
const JobSchema = z.object({
	...
	primary_abilities: z
		.array(z.enum(["STR", "AGI", "VIT", "INT", "SENSE", "PRE"]))
		.min(1),
	secondary_abilities: z
		.array(z.enum(["STR", "AGI", "VIT", "INT", "SENSE", "PRE"]))
		.optional(),
	...
	// Provenance
	source_kind: z.enum(["homebrew", "sa", "generated"]).default("homebrew"),
	source_name: z.string().default("Rift Ascendant Homebrew"),
