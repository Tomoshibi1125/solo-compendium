...
const OVERLAY_RENDER: TokenRenderStyle = {
	mode: "overlay",
	blendMode: "normal",
	opacity: 1,
};
const EFFECT_LIGHT_RENDER: TokenRenderStyle = {
	mode: "overlay",
	blendMode: "screen",
	opacity: 0.9,
};
const EFFECT_LIGHT_SOFT_RENDER: TokenRenderStyle = {
	mode: "overlay",
	blendMode: "screen",
	opacity: 0.7,
};
const EFFECT_DARK_RENDER: TokenRenderStyle = {
	mode: "overlay",
	blendMode: "multiply",
	opacity: 0.85,
};
const EFFECT_MIST_RENDER: TokenRenderStyle = {
	mode: "overlay",
	blendMode: "multiply",
	opacity: 0.6,
};
const EFFECT_SMOKE_RENDER: TokenRenderStyle = {
	mode: "overlay",
	blendMode: "multiply",
	opacity: 0.7,
};
const EFFECT_NEUTRAL_RENDER: TokenRenderStyle = {
	mode: "overlay",
	blendMode: "normal",
	opacity: 0.9,
};
...
export const normalizeLibraryTokens = (
	tokens: LibraryToken[],
): LibraryToken[] => {
...
export const mergeBaseTokens = (current: LibraryToken[]) => {
	...
	const missingDefaults = DEFAULT_TOKENS.filter(
