...
export const chaptersPart2: SandboxChapter[] = [
	{
		title: "Chapter 9: The Drowned Ledgerfen",
		content: `# The Drowned Ledgerfen
...
**Dread**: The water remembers everyone it has drowned — and it remembers you sick, dying, already gone, in a hand none of you taught it.
**The Lure**: Let it hold your hurt and it will — the wound, the fear, the memory of being ill — kept safe and cool in the black water.
**The Cost**: It keeps a memory of you whole and well in trade, and that one never comes back.
**If You Linger**: The fen stops asking what is wrong with you and decides — and its diagnosis is always *terminal*.

## Key Areas

### Intake Causeway

A narrow walkway crosses black floodwater. Clipboards hang from posts. If a character signs a form, they gain advantage on the next medical or investigation check here, but the Domain learns one true physical weakness.

### Triage Ward

Abandoned beds sit in rows. Some have patients made of wet paper and bone. They ask the party to read their names aloud. Doing so restores their faces, but summons a ward attendant.
...
The Catalog is a crystalline memory-thing grown from everything the Ledgerfen has ever drowned — a vast, cold awareness that mistakes *knowing* you for loving you. It is not initially hostile. It trades remembrance for remembrance: a true memory, a Bureau password, a real name, or a confession.
...
A half-transformed survivor floats in a sealed pod. Freeing them creates a possible ally and angers the Ledgerfen, which has already classified them as deceased.
...
- Multiattack with scalpel and restraint injection.
- Surgical Precision, crits on 19-20.
- Emergency Protocol at half HP, summoning paper-bodied orderlies.
- Anesthetic Cloud, 15 ft. cone, DC 13 Vitality save or unconscious for 1 minute with repeat saves.
...
`,
	...
	{
		title: "Chapter 10: The Fungal Depths",
		content: `# The Fungal Depths

## Rank and Role

**Rank**: D  
**Recommended Level**: 2-4  
**Campaign Role**: Adaptive ecology, body horror, the first true pressure site.

## Overview

The Fungal Depths are caverns beneath the Gloamreach where the Rift's mana taught the rot to *remember* — a living ecology that adapts, cultivates, and learns, sliding into wet decay at its lowest reaches. Pale shelves of fungus grow in long imitation rows; spore-clouds carry voices the caverns have copied; and the deeper the party goes, the more the place imitates rooms they have slept in, in shapes just wrong enough to notice.

> *Read aloud:* The air is warm, wet, and faintly sweet — and it breathes, in when you breathe out. Bioluminescence pulses along the walls in slow rows, like something reading. Ahead, your light finds a chamber laid out exactly like the last safe room you rested in, down to where you set your packs. You have never been here. It has.

The native settlements above give their dead, their grief, and their secrets to the Depths, and the Depths cultivate every one.

## What This Place Does

**Dread**: Anything that stays down here long enough is *cultivated* — grown into, grown through, made another part of the colony.
**The Lure**: A place to be rid of things — grief, corpses, secrets too heavy to carry. Bury them in the warm dark and walk out lighter.
**The Cost**: The rot copies whatever it takes. Your dead, your secrets, your sleeping face — it learns them all by heart.
**If You Linger**: What you buried grows a body of its own, wears your memory of it, and walks home ahead of you.

## Key Areas

### The Glowing Cavern

Beautiful, warm, and dangerous. Standing still for more than a minute requires a DC 10 Vitality save or hallucinations impose disadvantage on the next perception-based check.

### The Mycelium Maze

A DC 13 Survival or Sense check keeps the party on course. On failure, they loop for one hour and each character saves against spore exposure.

### The Nursery

Wet pods the size of people hang in rows, each grown around a secret a settlement buried here — a confession, a corpse, a name no one was supposed to say. Inside, the Depths are building *bodies* for them (the Failure: the secrets grow bodies and walk home). Burning a pod is safer. Reading the membrane-script labels teaches far more, and costs far more — because some of the names are about to become someone again.

### The Root Confessional

The fungi repeat confessions surrendered by nearby settlements. A character may learn a local lie, but must make a DC 13 Sense save or speak one true regret aloud.

## Boss: Mycelium Hive Queen

Reskin a **C-Rank brute/controller Anomaly from the compendium bestiary** (Appendix C) as the Mycelium Hive-Queen — less a creature than the Depths' whole network grown a mouth. Keep its source stat block; change only the costume. It clings to the ceiling, drags prey through spore-slick water, and **regenerates while in contact with the cavern network** (the entire Depths is its body).
...
- **The copied room** — whatever safe room the Depths imitated, the party will find the real one again later. It will never feel safe the same way.

> *Exit tone (read aloud):* The breathing fades behind you — then matches your pace again, one breath delayed — until you reach the surface and your own lungs are the only ones you can hear. Probably.
`,
	},
	{
		title: "Chapter 11: The Remembering Orchard",
		content: `# The Remembering Orchard

## Rank and Role

**Rank**: C  
**Recommended Level**: 5-7
**Campaign Role**: Travel horror; an Essence-ecology that learns your grief; a settlement-memory crisis.

## Overview

The Remembering Orchard is not a grove. It is an **anomalous Essence-bloom** — black, glassy resonance-stalks that erupted where the Rift's mana saturated an old evacuation greenhouse and taught grief to grow. Each stalk fruits **memory-cores**: Essence crystals, warm at the edges and cold at the heart, each holding a single extracted memory. Some are sweet. Some are rotten. Some belong to no one still alive.

It is an ecology that *learns*. The longer the party lingers, the more the orchard fruits in shapes they recognize: a face, a kitchen, a hand they have not held in years.
...
**Dread**: What you let yourself forget here does not leave you in peace — it takes root, fruits, and belongs to the Orchard now.
**The Lure**: Relief. Hand over a grief, a guilt, a face you cannot stop seeing, and the Orchard lifts it away, gently and whole.
**The Cost**: It takes a true memory with the pain, and you will never be sure which warm thing went missing alongside the wound.
**If You Linger**: The Orchard stops waiting to be offered anything and reaches in to *choose its own harvest*.
...
Memory-cores here hold pleasant things — first snow, a win, a warm room. Absorbing one (a touch is enough) grants a short Essence boon and a memory that is not yours. Take more than one and make a DC 13 Sense save or suffer **resonance bleed**: the borrowed memory starts answering to your name. Take too many, and the party can no longer agree on who remembers what.
...
Not a shed — a **harvest-station**: Bureau-issue Essence-extraction rigs, repurposed and grown over with stalk, every clamp and canister labeled with a household's ration-number rather than a name. The Caretaker keeps it immaculate. It is not cruel. It is *thorough*. That is worse.

## Boss: The Orchard Caretaker

Reskin a **C-Rank controller/stalker Anomaly from the compendium bestiary** (Appendix C) as the Caretaker — a memory-echo construct grown from the orchard's accumulated grief, wearing the shape of the last harvester it absorbed. Keep its source stat block; change only the costume. It does not prune branches. It prunes *people*.

**RA abilities (layer onto the source block):**

- **Pruning Hook** — melee; on a hit, the target loses access to one prepared Rune or technique until they recall a true memory aloud.
- **Graft** — the Caretaker presses a memory-core to a target; DC 14 Sense save or they act on a borrowed memory for one round (attack the wrong creature, defend the wrong ally).
- **Harvest Bell** — rings the resonance-chord; every claimed memory in the bloom answers at once, and unattended cores rise as grief-thralls.
...
`,
	...
	{
		title: "Chapter 12: The Ashen Counting-House",
		content: `# The Ashen Counting-House

## Rank and Role

**Rank**: C  
**Recommended Level**: 4-6  
**Campaign Role**: Fire-and-ash haunting; an endless burning hall where the dead are not permitted to stop dying.
...
**Dread**: Nothing here is allowed to finish burning. The fire took everyone and the fire *kept* them — shapes and voices still moving in the flame, still doing the thing they died doing.
**The Lure**: Warmth in a cold country, shelter from the road, and dead who know your face, call you by a kind name, and beg you to stay a while by the fire.
**The Cost**: The hall warms itself by burning. Sit too long and it begins to take your heat, your name, the years you have left, and feed them to the same unfinished blaze.
**If You Linger**: You stop being a guest and become part of the hall — another shape in the fire, learning the next traveler's face, begging them to stay.

## Key Areas

### Burning Lobby

Extreme heat. Without protection, characters take minor fire damage over time. The fire does not spread randomly. It opens a path where the dead want the party to walk, and closes behind them, herding them gently toward the warmth at the hall's heart.

### The Keeping-Boxes

Rows of iron boxes, each warm to the touch. Every one holds something the fire saved from a life it took — a wedding ring, a child's tooth, a letter never sent. Opening one (a key, a true name spoken to it, or a DC 15 tools check) gives up the keepsake and wakes the dead soul it belonged to, who will want to know why a stranger is holding it.

### The Asking-Floor

The oldest of the burning dead gather here and ask gentle, endless questions — who you were, who you have lost, who is waiting for you outside. Honest answers warm the dead and draw them closer; every truth told here is one the hall now keeps.

### The Vault of Stolen Years

Behind the deepest fire, native civilians hang suspended in amber heat — not dead, not living, the years of their lives slowly drawn out of them to feed the hall's endless burning. Freeing them returns those years all at once to the settlements they came from, with everything that implies.

## Boss: The Warden of Embers
...
`,
	...
	{
		title: "Chapter 13: The Sunken Tunnels",
		content: `# The Sunken Tunnels

## Rank and Role

**Rank**: B  
**Recommended Level**: 6-7  
**Campaign Role**: Claustrophobic travel, drowned infrastructure, old-city horror.
...
**Dread**: What goes under here does not come back up. The water keeps the drowned, and they are still down there — still reaching, still certain they need only one more breath.
**The Lure**: A shortcut. The tunnels promise to cut hours from the road, a fast dark way beneath everything that hunts the surface.
**The Cost**: The deep takes breath, warmth, and names — and the drowned will press theirs upon you, which is never a gift.
**If You Linger**: The way closes behind you, the water climbs to meet the ceiling, and the only path left is *down*, where the others went.
...
A long swim or raft crossing. Something large follows below without attacking until someone speaks.

### Shrine of Wet Candles

The Awoko maintain a shrine here. Their candles burn underwater. Destroying the shrine angers the Hollow Mother but weakens one cult ritual.

### Air Pocket Chapel

A place to rest, but only if the party leaves a light burning for the drowned.

## Boss: The Abyssal Leviathan

Use a B-Rank aquatic solo. It grapples, drags, and separates. It should feel less like a fish and more like the tunnel's hunger given muscle.
...
`,
	...
	{
		title: "Chapter 14: Bastion Golemfall",
		content: `# Bastion Golemfall

## Rank and Role

**Rank**: B  
**Recommended Level**: 7-8  
**Campaign Role**: The natives' last stand; failed protection; the Domain's law that drafts even the dead.
...
**Dread**: The siege never ended. The defenders swore to hold the line and they are holding it still, dead a hundred years, because here nothing is permitted to lay its duty down.
**The Lure**: Allies. The oathbound dead will stand beside the party, share old tactics, press warm Bastion iron into their hands — anyone who will help man the wall is welcome.
**The Cost**: The wall takes its help in kind. Stand the line with them and it begins to count you among its sworn, asking — every time — whether *you* are the relief that was promised.
**If You Linger**: The dead stop asking and begin to *draft*. You held the line once; now it will not let you leave it.
...
Rows of native wall-warden harness, each suit holding a defender's **echo**, bound by the oath to its gear. Touch one and live its last hour of the siege: tactical insight, and psychic strain as the echo asks — every time — whether *this* relief column is the one that was promised.

### The Wall That Fell

The breach itself — a battlefield that never finished. Fight here and you fight beside, and against, the oathbound dead and the half-risen **golem** cores still straining to close a gap that closed an age ago. The Domain keeps the battle warm because here, nothing is allowed to end.
...
Reskin a **B-Rank construct Anomaly from the compendium bestiary** (Appendix C) as the Oath-Forge Colossus — the greatest of the native Golems, the one the defenders poured their last oath into. Keep its source stat block; change only the costume.
...
`,
	...
	{
		title: "Chapter 15: The Obsidian Spire",
		content: `# The Obsidian Spire
...
A defeated enemy asks for the kind of mercy they denied others.
