...
- **Tank Contents** (d4 per tank examined):
  ...
  3. **Trap** — tank cracks, releasing toxic mana gas. DC 12 Constitution save or poisoned for 1 hour
...
- 4 **Bone Surgeons** (D-Rank Anomalies) patrol the wing. They wield surgical tools as weapons.
  - +4 to hit, 1d6+2 slashing, bonus action: inject target (DC 12 Con save or paralyzed for 1 round)

### The Archivist's Chamber (Third Floor)
- A sealed records room. Door requires DC 16 Thieves' Tools or DC 18 Strength.
- Inside: **The Archivist**, a sapient crystalline Anomaly that has absorbed the hospital's data systems.
- The Archivist is not hostile. It speaks in a flat, clinical tone and offers information in exchange for "data" — reports about the outside world, descriptions of other Gates, or personal memories.
...
- **Abilities**:
  - *Multiattack*: Scalpel slash (+6 to hit, 1d8+4 slashing) + Injection (+6 to hit, target makes DC 13 Con save or is restrained for 1 round)
  - *Surgical Precision*: Crits on 19-20
  - *Emergency Protocol* (at half HP): Summons 4 Writhing Husks and heals 10 HP
  - *Anesthetic Cloud* (1/day): 15 ft. cone, DC 13 Con save or fall unconscious for 1 minute (save at end of each turn)
...
- Standing still for more than 1 minute: DC 10 Con save or gain disadvantage on Perception (hallucinations) for 10 minutes.
...
- **Lost**: Party circles for 1 hour, each member makes DC 11 Con save vs. spore exposure (1d6 poison on fail).
...
- 6 **Mycelium Soldiers** (D-Rank): Humanoid fungal constructs. 
  - HP 18 | AC 12 | +3 to hit, 1d6+1 bludgeoning + DC 10 Con save or spore cloud (poisoned for 1 round)
...
- **Abilities**:
  ...
  - *Spore Burst* (Recharge 5-6): All creatures within 20 ft. make DC 13 Con save or take 3d6 poison and are blinded for 1 round
...
- **Hive Queen's Spore Sac** (uncommon Relic): Once per long rest, release a cloud in 15 ft. radius — enemies make DC 13 Con save or poisoned for 1 minute. Worth 1,000 Credits.
...
- **Root Trap Hazard**: DC 14 Perception to spot. Triggering: DC 13 Dex save or restrained. DC 14 Strength to break free, or take 1d6 bludgeoning per round as roots constrict.
- 4 **Thornback Prowlers** (C-Rank): Predatory plant-beasts that camouflage as foliage.
  - HP 32 | AC 14 (natural bark armor) | +5 to hit, 2d6+3 piercing + DC 12 Con save or 1d6 poison
...
- **Echo-7's Nest**: A partially transformed human-plant hybrid living in an apartment on the 6th floor. Echo-7 was an Ascendant who entered this Gate weeks ago and was changed by the mana saturation.
  ...
  - **Recruitment**: If the party promises to find a cure (requires Dr. Voss's help + a tissue sample from the boss), Echo-7 joins as an NPC ally with both plant and human abilities.
...
- **Falling**: 20d6 fall damage to street level. DC 15 Dex save to grab a vine (halves distance).
...
- **Lyra's Dreamscape**: The psychic NPC Lyra can be found meditating on a platform of woven flowers. She's been communing with the Gate's mana field.
  - **Lyra** offers to share a vision: the party briefly sees through the Regent's eyes — darkness, hunger, chains of light (the Relics) binding it.
  - **Recruitment**: Agree to enter the Regent's Domain. Lyra wants to understand the Regent's mind.
...
- **Abilities**:
  ...
  - *Pollen Storm* (1/day): 60 ft. radius. DC 14 Con save or charmed for 1 minute (target views the Bloom Tyrant as an ally). Save at end of each turn.
...
- **Collapsing Floor Hazard** (Floors 3-8): DC 13 Perception to spot weak floors. If not spotted, DC 14 Dex save or fall through (2d6 bludgeoning + 1d6 fire from landing in flames below).
- Random encounters per 2 floors climbed (d4):
  1. 2 Cinder Wraiths
  2. **Flame Geyser**: DC 13 Dex save, 3d6 fire on failure
...
- The Cult has set up operations here. High Priestess Nyx is NOT present, but her lieutenant **Blood Zealot Karn** (Level 7) leads the ritual.
...
- **Abilities**:
  ...
  - *Inferno Wave* (Recharge 5-6): 30 ft. cone, DC 15 Dex save, 4d6 fire (half on save)
...
- **Pressure**: Below 100 ft. depth, DC 14 Con save per minute or 2d6 bludgeoning.
...
- **Awoko Cult Forward Base**: The cult has established a forward base in a dry chamber. 4 Cult members + The Prophet (Whisper).
  ...
  - If approached alone: Whisper offers intelligence on High Priestess Nyx in exchange for safe passage out of the Gate.
  - **Information**: Nyx plans to trigger a simultaneous Gate Break across all remaining Gates on Day 10.

### The Architect's Workshop (Dry Chamber)
- A large air-pocketed cavern where **The Architect** (Level 7 Artificer NPC) has been living for weeks.
- The Architect is building a **Gate Suppression Device** — a mana-tech machine that can prevent Gate Breaks.
- **The Architect needs**:
  1. A B-Rank Anomaly core (from the boss of this Gate)
  2. Technical schematics from Dr. Voss (Bureau HQ)
...
- **Recruitment**: Complete the device. The Architect joins the party for the final battle.
...
- **Weakness**: Lightning damage. The Leviathan's scales conduct — lightning attacks deal extra 1d8 and force a DC 14 Con save or stunned for 1 round.
...
## Environmental Rules
- **Extreme Cold**: DC 12 Con save every hour or gain 1 level of exhaustion (cold resistance negates)
...
- DC 14 Dex save to maintain footing during combat on the bridge
...
- **Abilities**:
  ...
  - *Flash Freeze* (Recharge 5-6): DC 16 Con save in 20 ft. radius. Fail: restrained (encased in ice). DC 16 Str at end of turn to break free. If still frozen after 2 rounds: petrified (frozen solid).
...
- **Abilities**:
  ...
  - *Reality Warp* (Recharge 5-6): Teleports all creatures within 30 ft. to random positions on the floor. DC 16 Wis save or disoriented (disadvantage on attacks for 1 round).
...
- **Abilities**:
  ...
  - *Obsidian Shatter* (Recharge 5-6): Stomps the ground. 30 ft. radius, DC 17 Dex save, 5d8 piercing (obsidian shrapnel). Half on save.
...
- **Allies Present**: Any recruited NPCs fight alongside the party (max 3 NPC allies).
  ...
  - The Architect (if device complete): Activates a mana dampening field (Regent loses 1 ability)
...
- **Abilities**:
  ...
  - *Void Gaze* (Recharge 5-6): 60 ft. cone, DC 18 Wis save. Fail: frightened + 4d8 psychic. Success: half damage, no fear.
...
- *Shadow Storm* (Replaces Shadow Army): 60 ft. radius, all creatures take 3d8 necrotic at start of Regent's turn. DC 17 Con save for half.
