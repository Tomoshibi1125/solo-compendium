...
export const items_part2: Item[] = [
	{
		...
		weight: 5,
		value: { currency: "crystal", amount: 680 },
	...
	},
	{
		...
		weight: 4,
		value: { currency: "crystal", amount: 2110 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 3,
		value: { currency: "gate", amount: 124 },
		item_type: "weapon",
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 155 },
		item_type: "weapon",
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 169 },
		item_type: "armor",
	...
	},
	{
		...
		weight: 7,
		value: { currency: "crystal", amount: 3460 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 8,
		value: { currency: "crystal", amount: 3250 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 3,
		value: { currency: "crystal", amount: 3670 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 8,
		value: { currency: "gate", amount: 336 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d8",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 4,
		value: { currency: "gate", amount: 452 },
		item_type: "shield",
		armor_class: "+2",
		armor_type: "Shield",
		properties: {},
	...
	},
	{
		...
		weight: 5,
		value: { currency: "gate", amount: 368 },
		item_type: "armor",
	...
	},
	{
		...
		weight: 6,
		value: { currency: "crystal", amount: 610 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 7,
		value: { currency: "crystal", amount: 4100 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 432 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d10",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 4,
		value: { currency: "gate", amount: 417 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "2d6",
		damage_type: "force",
	...
	},
	{
		...
		weight: 3,
		value: { currency: "gate", amount: 112 },
		item_type: "armor",
		armor_class: "12 + AGI modifier",
		armor_type: "Light",
		properties: {},
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 280 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d12",
	...
	},
	{
		...
		weight: 8,
		value: { currency: "gate", amount: 437 },
		item_type: "weapon",
		weapon_type: "simple melee",
		damage: "1d4",
		damage_type: "force",
	...
	},
	{
		...
		weight: 8,
		value: { currency: "crystal", amount: 2980 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 8,
		value: { currency: "crystal", amount: 1720 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 2,
		value: { currency: "crystal", amount: 1860 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 1,
		value: { currency: "crystal", amount: 4130 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 7,
		value: { currency: "crystal", amount: 1000 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 8,
		value: { currency: "gate", amount: 248 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "2d6",
		damage_type: "bludgeoning",
	...
	},
	{
		...
		weight: 5,
		value: { currency: "gate", amount: 310 },
		item_type: "weapon",
		weapon_type: "martial ranged",
		damage: "1d10",
		damage_type: "radiant",
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 505 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "2d4",
	...
	},
	{
		...
		weight: 4,
		value: { currency: "gate", amount: 380 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "2d6",
		damage_type: "bludgeoning",
	...
	},
	{
		...
		weight: 6,
		value: { currency: "crystal", amount: 4680 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 6,
		value: { currency: "crystal", amount: 1170 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 1,
		value: { currency: "gate", amount: 444 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d6",
		damage_type: "necrotic",
