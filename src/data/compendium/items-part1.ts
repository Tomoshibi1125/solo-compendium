...
export const items: Item[] = [
  {
    ...
    "description": "A legendary longsword forged in the shadow realm, imbued with the power of the Ascendant. The blade appears as a normal sword but transforms in combat, radiating shadow energy that strikes fear into enemies.",
    "rarity": "legendary",
    "type": "weapon",
