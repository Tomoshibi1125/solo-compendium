...
const DISCOVERY_LORE_POOL: string[] = [
	"Recovered from a collapsing C-Rank gate by a Bureau extraction team that barely made it out alive.",
	"First documented when an E-Rank Hunter's Awakening discharged it involuntarily during a routine measurement exam.",
	"Transcribed from gate-wall inscriptions found in an abandoned A-Rank dungeon beneath the Korean DMZ.",
	"Emerged spontaneously in a Mage's spellbook overnight — the pages were still warm when she found them.",
	"Reconstructed from fragmentary notes left by a Guild Master who vanished during the Jeju Island Raid.",
	"Traded by a nomadic Awakened who claimed the technique came to her in a recurring dream about a white gate.",
	"Identified by Bureau analysts after cross-referencing combat footage from seven independent gate clears.",
	"Developed by Academy of High Magic researchers attempting to replicate an anomaly's natural attack pattern.",
	"Found inscribed on a gate-crystal shard that fell from an S-Rank Red Gate before it closed on its own.",
	"Adapted from a Technomancer's failed prototype — the 'failure' turned out to be more useful than the original design.",
	"Surfaced during a double-Awakening event when the Hunter's mana circuit overloaded and produced the effect spontaneously.",
	"Documented by a Stalker who observed a Beast-Class anomaly using a similar technique and reverse-engineered the mana flow.",
	"Extracted from the dissolution cloud of a gate boss — the residual mana crystallized into a readable lattice pattern.",
	"Classified by the Bureau after a Herald used it to stabilize a collapsing gate for six hours straight.",
	"Discovered in the personal journal of the First Ascendant, written in a language that no living linguist can fully translate.",
	"Manifested during a live combat exercise when a cadet's fear response triggered an uncontrolled mana discharge.",
	"Pieced together from three separate incomplete scrolls found in gates on three different continents.",
	"Created by an Esper who claimed the formula was 'broadcast' directly into her mind by an unknown source.",
	"Standard Bureau-issue since the Seoul Protocols — every licensed Hunter above D-Rank is expected to recognize it.",
	"Recovered from the wreckage of a mobile gate-research laboratory destroyed during the Osaka Incident.",
	"Originally a Revenant funeral rite repurposed for combat after a desperate last stand inside an S-Rank gate.",
	"Leaked onto the black market by a disgraced Bureau researcher. The Bureau pretends it doesn't exist.",
	"Compiled from oral traditions of pre-Bureau Awakened who operated without formal training or government oversight.",
	"Developed independently by three different Mages on three different continents within the same calendar week.",
	"Found etched into the armor of a long-dead Hunter recovered from a gate that had been sealed for decades.",
	"Generated by a Technomancer AI subroutine that was analyzing gate-crystal resonance frequencies.",
	"Taught exclusively at the Shadow Legion academy until a defector brought the technique to the Bureau.",
	"Recorded by a Contractor after negotiating with an entity that demanded a 'fair exchange' of knowledge.",
	"Materialized as a runestone drop from a dungeon boss that had never been documented producing spell components.",
	"Identified when a Holy Knight's oath-manifestation produced an effect no existing Bureau classification could explain.",
	"Catalogued after an Idol's concert performance caused a mass mana resonance event in the audience.",
	"Reconstructed from damaged security footage of a National-Level Hunter engaging three S-Rank anomalies simultaneously.",
	"Donated to the Bureau archives by a retiring A-Rank Summoner who said she 'wouldn't need it where she was going.'",
	"Spontaneously generated in a gate-adjacent research facility when ambient mana levels exceeded measurement capacity.",
	"Copied from a Berserker's combat instinct — the original user couldn't explain the technique, only perform it.",
	"Excavated from a pre-Awakening archaeological site that should not have contained any mana-related artifacts.",
	"Developed during the Gwangju Crisis when standard Bureau protocols proved inadequate against phasing anomalies.",
	"First cast by accident when a student mixed up two entirely different lattice diagrams during a practical exam.",
	"Transmitted via encrypted dead drop by an anonymous source the Bureau has designated 'PHANTOM LECTURER.'",
	"Confirmed field-viable after a Striker used it to solo-clear a gate that was rated two ranks above their classification.",
];

const FLAVOR_POOL: string[] = [
	"The Bureau tried to standardize it. The spell disagreed.",
	"Every Guild has a slightly different version. All of them work.",
	"Simple to learn. Difficult to survive if you get it wrong.",
	"The Academy calls it foundational. Field operatives call it essential.",
	"There are faster techniques. There are none more reliable.",
	"Bureau training manuals list it as 'optional.' Nobody skips it.",
	"The first time is always the hardest. The hundredth time is automatic.",
	"It leaves a distinctive resonance signature that other Awakened can feel.",
	"Gate-born creatures instinctively retreat from this effect. Scientists don't know why.",
	"The mana cost is negligible. The psychological cost is not.",
	"Healers love it. The things you use it on do not.",
	"A standard tool in every guild's emergency protocol.",
	"The older Hunters remember when this was considered impossible.",
	"Bureau R&D spent three years trying to reproduce this artificially. They failed.",
	"There's a reason this is the first thing they teach you after Awakening.",
	"It smells like ozone and tastes like copper. You get used to it.",
	"The lattice pattern is beautiful if you have Aetheric-Sight. Terrifying if you don't.",
	"Named after the Hunter who discovered it. She didn't survive to see it standardized.",
	"Guild veterans swear by it. Rookies swear at it.",
	"Clean, efficient, and utterly without mercy.",
	"The mana signature is unmistakable. Every sensor in range will know you cast it.",
	"It works better than it should. Bureau analysts suspect a deeper mechanism they haven't identified.",
	"Field-tested in over 200 documented gate clears across four continents.",
	"The technique is Bureau-approved. The way most hunters use it is not.",
	"There are three known variations. The third one is classified.",
	"It resonates differently depending on your Awakening type. No two casters produce the same effect.",
	"The black market version is cheaper but unstable. Not recommended.",
	"A favorite of solo hunters who can't afford to miss.",
	"The gate-crystal component is optional but dramatically improves stability.",
	"Bureau combat analysts rate this as 'high-efficiency, low-collateral.' A rare combination.",
	"It leaves a mark. Not on the target. On you.",
	"Every Ascendant who's been inside an S-Rank gate knows this one.",
	"The Academy teaches the safe version. The field teaches the real version.",
	"It's loud, bright, and impossible to miss. Stealth operators hate it.",
	"There's an elegance to it that only other casters appreciate.",
	"The resonance feedback feels like standing too close to a speaker at full volume.",
	"Fast enough to cast between heartbeats. Powerful enough that you'll need the next one.",
	"The old Guild Masters called this 'the final argument.' It usually is.",
	"It works on anomalies that resist everything else. Nobody knows why.",
	"The Bureau classifies this as 'proportional response.' The craters suggest otherwise.",
];
...
function makeSpell(seed: SpellSeed): CompendiumSpell {
	...
	return {
		...
		flavor: pickVariant(seed, FLAVOR_POOL),
		...
		discovery_lore:
			DISCOVERY_LORE_POOL[
				(seed.variant * 7 + seed.level * 3) % DISCOVERY_LORE_POOL.length
			],
