 ...
 * - Regent = A divine class overlay shared by a deity
 * - Sovereign = A fused prestige class born from two Regents
 * - Umbral = Shadows / darkness domain
 * - Resurge = The command to extract and resurrect the fallen
 * - Umbral Echoes = The shadow summons formed from defeated enemies
 * - Eternal = A deity of the pantheon (replaces Monarch)
 * - Exarchs = The celestial entities of light (replaces Rulers)
 * - Ascendant Bureau = The governing organization
 * - Decree Warden = The arbiter / game master
		...
		relationships: [
			{
				...
				type: "ally",
				description:
					"Marthos reaps the fallen that Kael Voss extracts into his Umbral Legion.",
			},
			{
				id: "kronos",
				name: "Kronos",
				type: "servant",
				description:
					"Kronos guards the flow of time that the Prime Eternal rebuilt after the Reset.",
			},
		],
	},
	{
		...
		relationships: [
			{
				...
				type: "superior",
				description:
					"Xylo was the first being entrusted by the Prime Eternal to safeguard the knowledge of his remade world.",
			},
		],
	},
	{
		...
		specializations: ["Life", "Light", "Protection"],
		description:
			"Solara is the last fragment of the Radiant Exarchs — an echo of the celestial force that once opposed the Eternals in the war before time.",
		...
		worshippers:
			"Guardians, healers, Holy Knights, and Zenith-class protectors.",
		temples:
			"Radiant Spires — lofty towers that channel celestial mana into protective barriers over cities and gate-adjacent zones.",
		...
		relationships: [
			{
				...
				type: "enemy",
				description:
					"Solara fights the entropy that Marthos seeks to unleash upon the world.",
			},
		],
	},
	{
		...
		portfolio: ["Destruction", "Void-Breath", "Entropy", "End-Cycles"],
		sigil: "A fracturing dragon skull breathing purple fire",
		manifestation: "Breath of Dissolution (Void Scythe)",
		specializations: ["Death", "Grave", "Void", "War"],
		description:
			"Marthos is the Harbinger of Annihilation — the force that awakens when a realm has become too corrupted to save.",
		...
		relationships: [
			{
				...
				type: "ally",
				description:
					"The Prime Eternal and the Dragon-King are two sides of the same coin — Creation and Deletion.",
			},
		],
	},
	{
		...
		specializations: ["War", "Tactics", "Tempest"],
		description:
		...
		worshippers:
			"Destroyers, Berserkers, martial artists, guild champions, and competitive ascendants.",
		temples:
			"The Storm Gazes — fortresses built within perpetual lightning storms where ascendants duel to prove their rank.",
		...
		relationships: [
			{
				...
				type: "rival",
				description:
					"Vaelen's overwhelming speed clashes with Golem's immovable endurance.",
			},
		],
	},
	{
		...
		description:
			"Lyra is the Mother of Evolution — the primal force that drives all living things to adapt, multiply, and survive.",
		...
		relationships: [
			{
				...
				type: "ally",
				description:
					"Sylph carries the winds that spread Lyra's evolutionary gifts across the realms.",
			},
		],
	},
	{
		...
		portfolio: ["Time", "The Origin", "Celestial Order", "The Flow of Fate"],
		sigil: "A golden compass pointing to a cyan zero",
		manifestation: "The Catalyst of Eras (Artifact of Time)",
		specializations: ["Order", "Time", "Fate"],
		description:
			"Kronos is the last echo of the Absolute — the original creator of the Eternals and the Exarchs, now bound to the flow of time itself.",
		...
		worshippers:
			"Historians, time-mages, judges, and Ascendant Bureau archivists.",
		temples:
			"The Chronos Halls — ancient cathedrals at the edge of the known world where time flows differently.",
		...
		relationships: [
			{
				...
				type: "superior",
				description:
					"The Prime Eternal uses Kronos's dominion over time to maintain the world he rebuilt.",
			},
		],
	},
	{
		...
		relationships: [
			{
				...
				type: "ally",
				description:
					"Nyx provides the umbral cover; Sylph provides the gateway.",
			},
		],
	},
	{
		...
		portfolio: ["Stealth", "Beast-Morph", "Instinct", "Ambush"],
		...
		relationships: [
			{
				...
				type: "rival",
				description:
					"Nyx's cunning versus Vaelen's overwhelming force — finesse against power.",
			},
		],
	},
	{
		...
		portfolio: ["Arts", "Beauty", "Inspiration", "Soulcraft"],
		sigil: "A harp wreathed in flowing mana trails",
		manifestation: "Resonant Bow (Musical Weapon)",
		specializations: ["Beauty", "Inspiration", "Charm"],
		description:
			"Elara is the Spirit of Harmony — the force that preserves the beauty that makes existence worth fighting for.",
		...
		relationships: [
			{
				...
				type: "ally",
				description:
					"Elara finds the art in Lyra's organic growth — beauty in evolution.",
			},
		],
	},
	{
		...
		worshippers:
			"Tankers, miners, the Ascendant Bureau's infrastructure corps, and those who value endurance over speed.",
		temples:
			"The Deep Foundations — chambers at the very core of the earth where the pressure is immense and the stone is sacred.",
		...
		relationships: [
			{
				...
				type: "rival",
				description:
					"The Unyielding Stone versus the Void Breath — an eternal stalemate.",
			},
		],
	},
	{
		...
		worshippers:
			"Mages, Espers, frost-mages, seekers of hidden truths, and the Ascendant Bureau's examination board.",
		temples:
			"The Glacial Archives — silent, frozen sanctuaries built into the coldest reaches of the world.",
		...
		relationships: [
			{
				...
				type: "rival",
				description:
					"Cipher's hidden mysteries versus Xylo's recorded knowledge — an eternal tension between the hidden and the known.",
			},
		],
	},
];
