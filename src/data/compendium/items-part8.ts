...
export const items_part8: Item[] = [
	...
	},
	{
		...
		weight: 3,
		value: { currency: "gate", amount: 246 },
		item_type: "weapon",
	...
	},
	{
		...
		weight: 3,
		value: { currency: "gate", amount: 122 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "2d4",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 6,
		value: { currency: "gate", amount: 402 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d12",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 5,
		value: { currency: "crystal", amount: 4480 },
	...
	},
	{
		...
		weight: 5,
		value: { currency: "crystal", amount: 2310 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 3,
		value: { currency: "crystal", amount: 2240 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 485 },
		item_type: "armor",
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 466 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d10",
	...
	},
	{
		...
		weight: 3,
		value: { currency: "crystal", amount: 840 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 3,
		value: { currency: "gate", amount: 224 },
		item_type: "weapon",
	...
	},
	{
		...
		weight: 3,
		value: { currency: "gate", amount: 344 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d6",
		damage_type: "piercing",
	...
	},
	{
		...
		weight: 2,
		value: { currency: "crystal", amount: 1230 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 8,
		value: { currency: "crystal", amount: 1160 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 8,
		value: { currency: "crystal", amount: 2610 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 8,
		value: { currency: "gate", amount: 173 },
		item_type: "weapon",
	...
	},
	{
		...
		weight: 6,
		value: { currency: "crystal", amount: 3840 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 3,
		value: { currency: "crystal", amount: 2100 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 386 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d4",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 8,
		value: { currency: "gate", amount: 349 },
		item_type: "armor",
		armor_class: "17",
		armor_type: "Heavy",
		stealth_disadvantage: true,
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 340 },
		item_type: "armor",
		armor_class: "17",
		armor_type: "Heavy",
		stealth_disadvantage: true,
	...
	},
	{
		...
		weight: 3,
		value: { currency: "crystal", amount: 4340 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 6,
		value: { currency: "gate", amount: 431 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "2d4",
		damage_type: "piercing",
	...
	},
	{
		...
		weight: 7,
		value: { currency: "gate", amount: 343 },
		item_type: "armor",
		armor_class: "16",
		armor_type: "Heavy",
		stealth_disadvantage: true,
	...
	},
	{
		...
		weight: 3,
		value: { currency: "gate", amount: 435 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d6",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 7,
		value: { currency: "crystal", amount: 4630 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 1,
		value: { currency: "gate", amount: 181 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d10",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 4,
		value: { currency: "gate", amount: 332 },
		item_type: "weapon",
		weapon_type: "simple melee",
		damage: "1d4",
		damage_type: "slashing",
	...
	},
	{
		...
		weight: 8,
		value: { currency: "gate", amount: 338 },
		item_type: "weapon",
		weapon_type: "martial melee",
		damage: "1d6",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 2,
		value: { currency: "gate", amount: 361 },
		item_type: "weapon",
		weapon_type: "martial ranged",
		damage: "1d8",
		damage_type: "necrotic",
	...
	},
	{
		...
		weight: 6,
		value: { currency: "crystal", amount: 3890 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 6,
		value: { currency: "crystal", amount: 4380 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
	...
	},
	{
		...
		weight: 6,
		value: { currency: "crystal", amount: 280 },
		item_type: "consumable",
		properties: {},
		effects: {
			active: [
