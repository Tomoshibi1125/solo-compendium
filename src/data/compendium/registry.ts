...
export type OriginKind = "official-sourcebook" | "homebrew" | "srd" | "generated";
...
export const compendiumSourceRegistry: readonly RegisteredCompendiumSource[] = [
	...
	registeredSource({ id: "jobs/catalog", category: "jobs", modulePath: "src/data/compendium/jobs.ts", exportName: "jobs", role: "authoritative", origin: "official-sourcebook", lineage: [], description: "Complete official Rift Ascendant job catalog.", load: () => import("./jobs").then((m) => asUnknownArray(m.jobs)) }),
	...
	registeredSource({ id: "paths/catalog", category: "paths", modulePath: "src/data/compendium/paths.ts", exportName: "paths", role: "authoritative", origin: "official-sourcebook", lineage: [], description: "All official Rift Ascendant job paths.", load: () => import("./paths").then((m) => asUnknownArray(m.paths)) }),
