...
export const comprehensiveSkills: Skill[] = [
	// SHADOW SKILLS (Expanded)
	{
		...
		description:
			"The ability to extract shadows from defeated enemies and bind them to your service.",
		ability: "Wisdom",
		type: "shadow",
	...
	},
	{
		...
		name: "Shadow Step",
		description:
			"Teleport through shadows between areas of dim light or darkness.",
		ability: "Dexterity",
		type: "shadow",
	...
	},
	{
		...
		name: "Shadow Stealth",
		description:
			"Advanced stealth techniques using shadows to remain undetected.",
		ability: "Dexterity",
		type: "shadow",
	...
	},
	{
		...
		name: "Shadow Magic",
		description:
			"Understanding and manipulation of shadow energy and dark magic.",
	...
	},
	{
		...
		name: "Shadow Command",
		description:
			"The ability to command and control shadow beings and entities.",
		ability: "Charisma",
		type: "shadow",
	...
	},
	{
		...
		name: "Sword Mastery",
		description:
			"Expertise with all types of swords, from short swords to greatswords.",
		ability: "Strength",
		type: "combat",
		uses: "Passive",
		mechanics: {
	...
	},
	{
		...
		description:
			"Expertise in navigating cities, towns, and other civilized areas.",
		ability: "Intelligence",
		type: "exploration",
		uses: "Passive",
		mechanics: {
	...
	},
	{
		...
		name: "Spellcraft",
		description:
			"The practical art of casting, modifying, and creating spells.",
		ability: "Intelligence",
		type: "magical",
		uses: "Varies by spell",
		mechanics: {
	...
	},
	{
		...
		name: "Magical Theory",
		description:
			"Deep understanding of how magic works at a fundamental level.",
		ability: "Intelligence",
		type: "magical",
		uses: "Knowledge check",
		mechanics: {
	...
	},
	{
		...
		name: "Alchemy",
		description:
			"The art of brewing potions, creating magical substances, and chemical reactions.",
		ability: "Intelligence",
		type: "crafting",
		uses: "Crafting action",
		mechanics: {
	...
	},
	{
		...
		name: "Enchanting",
		description:
			"The art of imbuing items with magical properties and enchantments.",
		ability: "Intelligence",
		type: "crafting",
		uses: "Crafting action",
		mechanics: {
