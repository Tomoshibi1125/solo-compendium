...
export const items_part6: Item[] = [
	{
		...
		tags: ["equipment", "debuff", "stealth", "fire"],
		theme_tags: ["monarch-era", "forbidden"],
	},
	{
		id: "item_p6_1",
		...
		flavor:
			"Purges the illusion of safety. A reminder that the System has no mercy.",
		discovery_lore:
			"Recovered from a time-locked chest that required three different elemental keys to open.",
		tags: ["equipment", "radiant", "shadow", "debuff"],
		theme_tags: ["monarch-era", "dungeon-core", "urban-combat"],
	},
	{
		id: "item_p6_2",
	...
	},
	{
		...
		flavor:
			"Erases the architect's design. The final equation in a war without end.",
		discovery_lore:
			"Recovered from a time-locked chest that required three different elemental keys to open.",
		tags: ["equipment", "utility", "debuff", "burst"],
		theme_tags: ["monarch-era", "ancient-power"],
	},
	{
		id: "item_p6_4",
		...
		flavor:
			"Binds the laws of physics. A reminder that the System has no mercy.",
		discovery_lore:
			"Gifted by the System itself as a reward for completing a hidden quest chain.",
		tags: ["equipment", "mobility", "area", "fire"],
	...
	},
	{
		...
		flavor:
			"Condemns the remnants of a dead world. The line between Hunter and monster.",
		discovery_lore:
			"Recovered from a time-locked chest that required three different elemental keys to open.",
		tags: ["equipment", "lightning", "buff", "shadow", "mobility"],
	...
	},
	{
		...
		flavor:
			"Rends the silence between heartbeats. The breaking point of all resistance.",
		discovery_lore:
			"Found in a hidden compartment of a relic weapon that had been in Guild storage for years.",
		tags: ["equipment", "defensive", "sustained", "radiant", "buff"],
	...
	},
	{
		...
		flavor:
			"Warps the concept of distance. A whisper from the edge of oblivion.",
		discovery_lore:
			"Recovered from a time-locked chest that required three different elemental keys to open.",
		tags: ["equipment", "radiant", "control", "defensive"],
	...
	},
	{
		...
		flavor:
			"Binds the silence between heartbeats. The death of hesitation, made manifest.",
		discovery_lore:
			"Found pulsing with residual mana in the aftermath of a Gate break, half-buried in shattered concrete.",
		tags: ["equipment", "utility", "damage"],
		theme_tags: ["monarch-era", "elite-tier", "classified"],
	},
	{
		id: "item_p6_9",
		...
		flavor:
			"Corrodes the remnants of a dead world. A reminder that the System has no mercy.",
		discovery_lore:
			"Found washed ashore near a coastal Gate, wrapped in fabric that dissolved upon touch.",
		tags: ["equipment", "utility", "defensive"],
	...
	},
	{
		...
		flavor:
			"Commands the architect's design. A whisper from the edge of oblivion.",
		discovery_lore:
			"Found in a hidden compartment of a relic weapon that had been in Guild storage for years.",
		tags: ["equipment", "utility", "necrotic"],
	...
	},
	{
		...
		flavor:
			"Absorbs the threshold of human potential. The final equation in a war without end.",
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "void", "damage", "lightning", "offensive"],
	...
	},
	{
		...
		flavor:
			"Sanctifies the illusion of safety. A reminder that the System has no mercy.",
		discovery_lore:
			"Excavated from the crystallized mana deposit at the center of a depleted Gate core.",
		tags: ["equipment", "defensive", "void", "debuff"],
	...
	},
	{
		...
		flavor:
			"Crushes the dimensional barrier. The line between Hunter and monster.",
		discovery_lore:
			"Excavated from the crystallized mana deposit at the center of a depleted Gate core.",
		tags: ["equipment", "utility", "buff"],
	...
	},
	{
		...
		flavor:
			"Sanctifies the concept of distance. Proof that some things cannot be survived.",
		discovery_lore:
			"Found washed ashore near a coastal Gate, wrapped in fabric that dissolved upon touch.",
		tags: ["equipment", "burst", "necrotic"],
	...
	},
	{
		...
		flavor:
			"Warps the laws of physics. Evolution compressed into a single, violent instant.",
		discovery_lore:
			"Found washed ashore near a coastal Gate, wrapped in fabric that dissolved upon touch.",
		tags: ["equipment", "area", "ice"],
	...
	},
	{
		...
		flavor:
			"Eclipses the concept of distance. The final equation in a war without end.",
		discovery_lore:
			"Gifted by the System itself as a reward for completing a hidden quest chain.",
		tags: ["equipment", "defensive", "single-target"],
	...
	},
	{
		...
		flavor:
			"Reclaims the illusion of safety. A reminder that the System has no mercy.",
		discovery_lore:
			"Located by a detection-type Hunter whose radar ability triggered on an otherwise empty room.",
		tags: ["equipment", "control", "sustained"],
	...
	},
	{
		...
		flavor:
			"Absorbs the remnants of a dead world. Evolution compressed into a single, violent instant.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "sustained", "defensive", "shadow"],
	...
	},
	{
		...
		flavor:
			"Commands the architecture of the soul. A reminder that the System has no mercy.",
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "mobility", "offensive", "necrotic", "radiant"],
	...
	},
	{
		...
		flavor:
			"Overrides the silence between heartbeats. The death of hesitation, made manifest.",
		discovery_lore:
			"Materialized on a Hunter's workbench overnight, leaving scorch marks in the shape of unknown glyphs.",
		tags: ["equipment", "debuff", "support", "lightning"],
	...
	},
	{
		...
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "psychic", "burst"],
		theme_tags: ["forbidden", "monarch-era", "shadow-domain"],
	},
	{
		id: "item_p6_22",
		name: "Void Spear",
		...
		flavor:
			"Condemns the silence between heartbeats. The breaking point of all resistance.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "single-target", "healing"],
		theme_tags: ["monarch-era", "urban-combat", "shadow-domain"],
	},
	{
		id: "item_p6_23",
		name: "Shattered Sniper Rifle",
		...
		tags: ["equipment", "fire", "lightning", "stealth", "control"],
	...
	},
	{
		...
		flavor:
			"Ignites the fabric of reality. The last thing many anomalies ever see.",
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "buff", "utility", "defensive", "support"],
		theme_tags: ["monarch-era", "survival", "black-market"],
	},
	{
		id: "item_p6_25",
		name: "Void Katana",
		...
		flavor:
			"Unravels the certainty of outcomes. Proof that some things cannot be survived.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "sustained", "healing", "area"],
	...
	},
	{
		...
		flavor:
			"Binds the last defense of the unprepared. The breaking point of all resistance.",
		discovery_lore:
			"Appeared in a Hunter's inventory after a System notification that no one else could see.",
		tags: ["equipment", "void", "sustained", "offensive", "area"],
	...
	},
	{
		...
		flavor:
			"Mirrors the chains of mortality. A reminder that the System has no mercy.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "psychic", "burst"],
	...
	},
	{
		...
		flavor:
			"Ignites the fabric of reality. A whisper from the edge of oblivion.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "perception", "radiant", "void"],
	...
	},
	{
		...
		flavor:
			"Silences the fabric of reality. Evolution compressed into a single, violent instant.",
		discovery_lore:
			"Found pulsing with residual mana in the aftermath of a Gate break, half-buried in shattered concrete.",
		tags: ["equipment", "lightning", "buff", "burst"],
	...
	},
	{
		...
		flavor:
			"Overrides the dimensional barrier. A reminder that the System has no mercy.",
		discovery_lore:
			"Purchased from a black-market auction in the underground district of Neo-Seoul for an undisclosed sum.",
		tags: ["equipment", "necrotic", "defensive"],
		theme_tags: ["ancient-power", "monarch-era"],
	},
	{
		id: "item_p6_31",
		...
		flavor:
			"Erases the fabric of reality. A reminder that the System has no mercy.",
		discovery_lore:
			"Appeared in a Hunter's inventory after a System notification that no one else could see.",
		tags: ["equipment", "utility", "control"],
	...
	},
	{
		...
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "mobility", "healing"],
	...
	},
	{
		...
		flavor:
			"Unravels the architecture of the soul. The breaking point of all resistance.",
		discovery_lore:
			"Sold by a mysterious merchant who appears only during full moons near active Gate sites.",
		tags: ["equipment", "buff", "stealth", "necrotic"],
	...
	},
	{
		...
		flavor:
			"Annihilates the illusion of safety. A whisper from the edge of oblivion.",
		discovery_lore:
			"Purchased from a black-market auction in the underground district of Neo-Seoul for an undisclosed sum.",
		tags: ["equipment", "fire", "psychic", "damage", "defensive"],
	...
	},
	{
		...
		flavor:
			"Fractures the illusion of safety. The death of hesitation, made manifest.",
		discovery_lore:
			"Found washed ashore near a coastal Gate, wrapped in fabric that dissolved upon touch.",
		tags: ["equipment", "sustained", "support"],
	...
	},
	{
		...
		flavor:
			"Unravels the architecture of the soul. The final equation in a war without end.",
		discovery_lore:
			"Gifted by the System itself as a reward for completing a hidden quest chain.",
		tags: ["equipment", "control", "support"],
	...
	},
	{
		...
		flavor:
			"Shatters the certainty of outcomes. Evolution compressed into a single, violent instant.",
		discovery_lore:
			"Excavated from the crystallized mana deposit at the center of a depleted Gate core.",
		tags: ["equipment", "defensive", "single-target", "utility", "void"],
	...
	},
	{
		...
		flavor:
			"Shatters the concept of distance. A reminder that the System has no mercy.",
		discovery_lore:
			"Found in a hidden compartment of a relic weapon that had been in Guild storage for years.",
		tags: ["equipment", "lightning", "healing"],
	...
	},
	{
		...
		flavor:
			"Rends the remnants of a dead world. A testament to what Hunters have become.",
		discovery_lore:
			"Emerged from a Gate Boss's dissolution cloud, hovering where the creature's heart had been.",
		tags: ["equipment", "lightning", "fire", "defensive"],
	...
	},
	{
		...
		flavor:
			"Devours the architect's design. The death of hesitation, made manifest.",
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "shadow", "damage"],
		theme_tags: ["elite-tier", "monarch-era", "dimensional-bleed"],
	},
	{
		id: "item_p6_41",
		name: "Crimson Spear",
		...
		flavor:
			"Inverts the silence between heartbeats. The line between Hunter and monster.",
		discovery_lore:
			"Appeared in a Hunter's inventory after a System notification that no one else could see.",
		tags: ["equipment", "psychic", "stealth"],
	...
	},
	{
		...
		flavor:
			"Eclipses the dimensional barrier. Proof that some things cannot be survived.",
		discovery_lore:
			"Excavated from the crystallized mana deposit at the center of a depleted Gate core.",
		tags: ["equipment", "shadow", "control", "psychic"],
	...
	},
	{
		...
		flavor:
			"Silences the flow of causality. A beautiful catastrophe measured in milliseconds.",
		discovery_lore:
			"Excavated from the crystallized mana deposit at the center of a depleted Gate core.",
		tags: ["equipment", "shadow", "offensive", "support", "debuff"],
	...
	},
	{
		...
		flavor:
			"Sanctifies the remnants of a dead world. A beautiful catastrophe measured in milliseconds.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "lightning", "damage", "mobility"],
		theme_tags: ["dimensional-bleed", "monarch-era", "elite-tier"],
	},
	{
		id: "item_p6_45",
		...
		flavor:
			"Crushes the laws of physics. Evolution compressed into a single, violent instant.",
		discovery_lore:
			"Found in a hidden compartment of a relic weapon that had been in Guild storage for years.",
		tags: ["equipment", "shadow", "fire", "stealth"],
	...
	},
	{
		...
		flavor:
			"Dissolves the boundary between life and death. The line between Hunter and monster.",
		discovery_lore:
			"Purchased from a black-market auction in the underground district of Neo-Seoul for an undisclosed sum.",
		tags: ["equipment", "radiant", "shadow"],
	...
	},
	{
		...
		flavor:
			"Warps the silence between heartbeats. The reason S-Rank Gates are feared.",
		discovery_lore:
			"Sold by a mysterious merchant who appears only during full moons near active Gate sites.",
		tags: ["equipment", "radiant", "support"],
	...
	},
	{
		...
		flavor:
			"Shatters the last defense of the unprepared. A beautiful catastrophe measured in milliseconds.",
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "burst", "damage", "shadow"],
	...
	},
	{
		...
		flavor:
			"Eclipses the last defense of the unprepared. Proof that some things cannot be survived.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "fire", "radiant", "area"],
