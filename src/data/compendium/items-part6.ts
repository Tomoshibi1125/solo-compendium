...
export const items_part6: Item[] = [
	...
	},
	{
		...
		flavor:
			"Purges the illusion of safety. A reminder that the Order has no mercy.",
		discovery_lore:
	...
	},
	{
		...
		flavor:
			"Binds the laws of physics. A reminder that the Order has no mercy.",
		discovery_lore:
	...
	},
	{
		...
		flavor:
			"Corrodes the remnants of a dead world. A reminder that the Order has no mercy.",
		discovery_lore:
	...
	},
	{
		...
		flavor:
			"Sanctifies the illusion of safety. A reminder that the Order has no mercy.",
		discovery_lore:
			"Excavated from the crystallized mana deposit at the center of a depleted Gate core.",
	...
	},
	{
		...
		flavor:
			"Reclaims the illusion of safety. A reminder that the Order has no mercy.",
		discovery_lore:
	...
	},
	{
		...
		flavor:
			"Commands the architecture of the soul. A reminder that the Order has no mercy.",
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
	...
	},
	{
		...
		flavor:
			"Mirrors the chains of mortality. A reminder that the Order has no mercy.",
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "psychic", "burst"],
	...
	},
	{
		...
		flavor:
			"Overrides the dimensional barrier. A reminder that the Order has no mercy.",
		discovery_lore:
			"Purchased from a black-market auction in the underground district of Neo-Seoul for an undisclosed sum.",
	...
	},
	{
		...
		flavor:
			"Erases the fabric of reality. A reminder that the Order has no mercy.",
		discovery_lore:
			"Appeared in a Hunter's inventory after a Order notification that no one else could see.",
	...
	},
	{
		...
		flavor:
			"Shatters the concept of distance. A reminder that the Order has no mercy.",
		discovery_lore:
			"Found in a hidden compartment of a relic weapon that had been in Guild storage for years.",
