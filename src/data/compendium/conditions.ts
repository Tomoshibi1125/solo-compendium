...
export const conditions: Condition[] = [
	...
	},
	{
		...
		type: "exploration",
		description:
			"Exhaustion is measured in six levels. Each level of exhaustion has a cumulative effect.",
		effects: [
	...
	},
	{
		...
		type: "shadow",
		description:
			"Exhaustion from surviving a rift raid or intense shadow energy exposure.",
		effects: [
	...
	},
	{
		...
		type: "shadow",
		description:
			"The creature is magically bound to a shadow master or location.",
		effects: [
		...
		removal: [
			"Binder dies or releases the binding",
			"Dispel magic spell",
	...
	},
	{
		...
		type: "shadow",
		description:
			"Marked by a Regent for death or recruitment. The mark cannot be hidden.",
		effects: [
