...
export const backgrounds: CompendiumBackground[] = [
	{
		...
		"features": [
			{
				...
				"description": "You have advantage on saving throws against being frightened. Your exposure to the rift allows you to see in dim light within 60 feet as if it were bright light."
			},
			{
				"name": "Urban Rift Navigation",
				"description": "You can sense the subtle aetheric vibrations of nearby dimensional rifts within 300 feet and know their general direction, having survived the initial city-level cataclysm."
			},
			{
				"name": "Essence Discernment",
				"description": "You can detect the presence of lingering aetheric energy in objects, allowing you to identify the raw potential of items without the use of high-tier sensory gear."
			}
		],
		"personalityTraits": [
		...
		"ideals": [
			...
			"Authority. No one should control the gates but those who clear them. (Chaotic)",
		...
		"description": "A former professionalâ€”contractor, engineer, or investigatorâ€”whose life was shattered when a gate opened in their workplace. You didn't just survive the cataclysm; you learned to navigate the new world of rifts and hunters as an independent operator.",
		"dangers": [
	...
	},
	{
		...
		"features": [
			{
				"name": "Rift Sense",
				"description": "You can feel vibrations that precede a dimensional rift opening. You have advantage on Sense (Perception) checks to detect planar disturbances, and you can sense when a rift will open within 1 mile up to 10 minutes before it manifests."
			},
			{
				"name": "Survivor's Fortitude",
				"description": "Having endured the raw energy of a rift collapse, your body has adapted. You have resistance to force damage from dimensional sources, and you have advantage on death saving throws when within 60 feet of an active rift."
			}
		],
		"personalityTraits": [
			"I compulsively count exits and escape routes in every room I enter.",
			"I flinch at sudden bursts of light or energyâ€”they remind me of the rift.",
		...
		"ideals": [
			...
			"Resilience. What doesn't kill you makes you strongerâ€”literally. (Neutral)",
		...
		"bonds": [
			...
			"I saw something inside the riftâ€”something that's still looking for me."
		],
		"flaws": [
		...
		"description": "You survived a catastrophic rift event that claimed the lives of countless others. The raw dimensional energy seared your body and mind, but you emerged changedâ€”tougher, sharper, and haunted by the screams of those who weren't so fortunate.",
		"dangers": [
			"Post-Traumatic Stress",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "You can gain access to ascendant organizations, libraries, and restricted archives by presenting your academy credentials. Fellow graduates offer you lodging and aid, and officials of ascendant guilds treat you with professional respect."
			},
			{
				"name": "Theoretical Framework",
				"description": "Your academic training allows you to identify rift types, Anomaly classifications, and dimensional anomalies. You have advantage on Intelligence checks to recall lore about rifts, gates, and dimensional entities."
			}
		],
		"personalityTraits": [
			...
			"I'm competitive with other ascendantsâ€”my academy ranking still matters to me.",
		...
		"ideals": [
			...
			"Innovation. Textbook methods aren't enoughâ€”we need new approaches. (Chaotic)"
		],
		"bonds": [
			...
			"A fellow graduate went missing on their first missionâ€”I will find them."
		],
		"flaws": [
		...
		"description": "You graduated from the prestigious Ascendant Academy, receiving formal training in combat, magic, and dimensional theory. The Academy's rigorous curriculum covered rift classification, Anomaly taxonomy, essence manipulation, and tactical coordination.",
		"dangers": [
			"Academic Rivals",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "You can leverage your reputation as a guild leader to requisition supplies, recruit temporary help from ascendant guilds, and negotiate favorable contracts. Guild members and merchants in ascendant districts recognize your authority."
			},
			{
				"name": "Strategic Command",
				"description": "Once per long rest, you can spend 10 minutes briefing your allies on a battle plan, granting each participating ally a +1 bonus to initiative rolls for the next encounter."
			}
		],
		"personalityTraits": [
			"I evaluate everyone I meet as a potential recruit or rival.",
			"I delegate tasks naturally and expect my orders to be followed.",
			"I keep track of favorsâ€”both owed and owing.",
		...
		"ideals": [
			...
			"Profit. Resources win warsâ€”I make sure we have plenty. (Neutral)",
		...
		"bonds": [
			...
			"I disbanded my guild after a disastrous rift raidâ€”I carry that weight.",
		...
		"flaws": [
			...
			"I invested everything in my guild and lost itâ€”I'm rebuilding from nothing.",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "You have an innate sense of orientation that works even within the distorted space of a gate. You cannot become lost by non-magical means while navigating a rift, and you have advantage on Sense (Survival) checks to track aetheric ripples."
			},
			{
				"name": "Spectral Adaptation",
				"description": "Your body has adapted to the high-pressure aetheric flow of gate transitions. You are immune to the disorientation effects of crossing the threshold and have advantage on Vitality saving throws against environmental hazards within a gate."
			}
		],
		"personalityTraits": [
		...
		"bonds": [
			...
			"Something followed me out of a gateâ€”a shadow that only I can see."
		],
		"flaws": [
			...
			"The high-concentrate aether has affected my memoryâ€”some days are a blur.",
			"I'm addicted to the sensation of crossing the gate-threshold."
		],
		"description": "A former hiker, urban explorer, or cartographer who was caught in a gate opening and survived. You've learned to navigate the sub-zero logic of the rift-realms, mapping the spaces between our world and the umbral domains. Your expertise is invaluable to guilds seeking to clear gates before they fully rupture.",
		"dangers": [
			"Aether-Sickness",
			"Reality Drift",
			"Specter Attention",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "You can feel the subtle pressure of aetheric energy in the air. You can detect active gates or high-rank essence signatures within 60 feet. This sensitivity allows you to sense the approach of gate-beasts moments before they manifest."
			},
			{
				"name": "Natural Resonance",
				"description": "Your body is a conductor for ambient aether. Once per long rest, when you finish a short rest near an active gate or a powerful Regent-tomb, you can vent this pressure to regain a fraction of your expended potential (1st level spell slot or equivalent ability choice)."
			}
		],
		"personalityTraits": [
		...
		"description": "You are an 'Aetheric Pulse'â€”one of the rare modern individuals whose body awakened with an exceptionally high resonance frequency. Without any formal training, the Rift's power flows through you like an electric current. You weren't a mage in a fantasy realm; you were a student, a gamer, or a clerk whose biology was rewritten by the cataclysm.",
		"dangers": [
			"Resonance Overload",
			"Guild Kidnapping",
			"System Desync",
	...
	},
	{
		...
		"features": [
			{
				"name": "Regent's Mark",
				"description": "You bear the mark of a Regentâ€”one of the apex gate-lords. You have advantage on Presence (Intimidation) checks against creatures of lower rank than your patron Regent, and gate-beasts that serve your Regent will not attack you unless provoked."
			},
			{
				"name": "Umbral Whisper",
				"description": "Once per long rest, you can receive a Directives-flashâ€”a cryptic sensation or vision from your Regent's domain. The Warden (Warden) determines if this is a warning or an order."
			}
		],
		"personalityTraits": [
		...
		"bonds": [
			...
			"I have a bitter rivalâ€”another Herald serving a competing Regent.",
		...
		"features": [
			{
				...
				"description": "When you are within 5 feet of an ally, you have advantage on saving throws against being frightened. You can use a bonus action to coordinate a defensive stance, granting an adjacent ally +2 to their AC until the start of your next turn."
			},
			{
				"name": "Gate-Line Stance",
				"description": "You've been trained to hold the door. When you take the Dodge action within 10 feet of an active gate or rift, you gain resistance to all damage from non-boss enemies for that round."
			}
		],
		"personalityTraits": [
	...
	},
	{
		...
		"features": [
			{
				"name": "Decree Lore",
				"description": "You can identify and read aetheric inscriptions of any origin. When you encounter a rune, you automatically know its source-domain and general Mandate. You have advantage on Intelligence (Arcana) checks to understand, activate, or disable System-wards and enchantments."
			},
			{
				"name": "Master Technician",
				"description": "During a long rest, you can inscribe a temporary System-ward on a surface or object. The ward lasts for 24 hours and provides one effect: a faint proximity alert, aetheric illumination, or resistance to one damage type for the first breach."
			}
		],
		"personalityTraits": [
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "Your long exposure to System-artifacts has made you sensitive to their auras. You can determine whether an object is high-tier by handling it for 1 minute (no Aether-Sight required). You also have advantage on Intelligence checks to identify the properties and System-history of Awakened items."
			},
			{
				"name": "Containment Mandates",
				"description": "You know the proper Decrees for safely handling volatile gate-born items. You have advantage on saving throws against cursed System-relics, and when you examine a tainted item, you become aware of its hidden logic before it takes effect on you."
			}
		],
		"personalityTraits": [
		...
		"ideals": [
			"Stewardship. These artifacts are part of a global archiveâ€”we merely watch them. (Good)",
		...
		"description": "You are a Vault Wardenâ€”a specialist in the containment and study of System-artifacts. You weren't a temple guardian; you were a high-security professional, a museum archivist, or a laboratory technician whose job changed when 'artifacts' replaced art. You've managed enough high-rank resonance to know that sometimes the items are studying you as much as you are studying them.",
		"dangers": [
			"Relic Corruption",
			"Guild Infiltration",
	...
	},
	{
		...
		"features": [
			{
				"name": "Boss-Sense",
				"description": "You can identify major gate-boss classifications by their mana-prints, lairs, or territorial logic. You have advantage on Sense (Survival) checks to track high-rank entities and on Intelligence (Nature) checks to recall information about Regent-servants."
			},
			{
				"name": "Slayer's Reputation",
				"description": "Guilds and settlements in high-risk gate zones treat you with veteran respect, offering discounted gear and premium intel. However, high-rank gate entities can sense your predatory intent and will prioritize you as the primary threat."
			}
		],
		"personalityTraits": [
		...
		"bonds": [
			...
			"A high-rank entity spared me onceâ€”I've spent years analyzing why.",
		...
		"description": "You are an Elite Breach-Tacticianâ€”a specialist who has successfully cleared high-rank gates and survived encounters with the Regents' generals. You weren't a medieval dragon slayer; you were a veteran hunter, a tactical lead, or a breach-specialist whose name is synonymous with survival. You know where to hit, when the Rift pulses, and how to use a Gate's own logic to bring it down.",
		"dangers": [
			"Target Assignment",
			"Guild Espionage",
			"Adrenaline Burnout",
	...
	},
	{
		...
		"features": [
			{
				"name": "Umbral Lore",
				"description": "You can identify umbral-beast types by their aether-residue, audio-prints, or the distortion they leave in the Rift. You have advantage on Intelligence checks related to spectral entities and Regent-servants."
			},
			{
				"name": "Detection Mandate",
				"description": "During a short rest, you can set up a tether-field in a 15-foot radius. Spectral entities have disadvantage on attack rolls while within the field, and you are immediately alerted if any 'invisible' entity enters the perimeter."
			}
		],
		"personalityTraits": [
	...
	},
	{
		...
		"features": [
			{
				"name": "Echo-Sense",
				"description": "You can feel the ghosting of the Rift's timeline. You have advantage on Initiative rolls and cannot be surprised as long as you are conscious. You can perceive 'Echoes' of past and future breaches within a 60-foot radius."
			},
			{
				"name": "Temporal Buffer",
				"description": "Your soul is slightly out of sync with the current Mandate. Once per long rest, you can use your reaction to force a re-roll of an attack against you, having witnessed the strike seconds before it occurred. You must take the new result."
			}
		],
		"personalityTraits": [
		...
		"bonds": [
			...
			"I am hunting the 'Gate-Warden'â€”the Regent-servant that guards the temporal-veins."
		],
		"flaws": [
	...
	},
	{
		...
		"features": [
			{
				"name": "Reality Sight",
				"description": "You can see through mundane illusions automatically (no check required) and have advantage on saving throws against illusion spells. You can detect seams in realityâ€”places where dimensional barriers are thinâ€”within 60 feet."
			},
			{
				"name": "Minor Bend",
				"description": "Once per long rest, you can make a minor alteration to local reality: change an object's color, make a small object appear or disappear, create a harmless sensory effect, or light or snuff out a candle. Changes last 1 hour."
			}
		],
		"personalityTraits": [
			"I question whether anything I see is realâ€”including this conversation.",
		...
		"ideals": [
			"Truth. Reality is a constructâ€”I seek what lies beneath it. (Neutral)",
			...
			"Chaos. The rules of reality are arbitraryâ€”I'll rewrite them. (Chaotic)"
		],
		"bonds": [
		...
		"flaws": [
			...
			"I've lost fragments of my own existenceâ€”moments, relationships, even body parts that flicker."
		],
	...
	},
	{
		...
		"features": [
			{
				"name": "Void Touched",
				"description": "You have darkvision out to 120 feet. Once per long rest, you can become invisible in dim light or darkness for 1 minute or until you attack or cast a spell."
			},
			{
				"name": "Null Aura",
				"description": "You emanate a subtle field that disrupts magical detection. You cannot be detected by divination magic unless the caster succeeds on a DC 15 ability check using their spellcasting ability."
			}
		],
		"personalityTraits": [
			...
			"I sometimes forget I existâ€”I have to remind myself I'm real."
		],
		"ideals": [
		...
		"bonds": [
			...
			"Someone pulled me back from the void's edgeâ€”I owe them everything.",
			"The void gave me a vision of something terrible that will happenâ€”I must prevent it.",
		...
		"description": "You have been exposed to the pure void between dimensionsâ€”the absolute nothingness that exists where reality ends. Most who touch the void are unmade entirely. You survived, but you were changed in fundamental ways.",
		"dangers": [
			"Existence Erosion",
			"Memory Loss",
			"Emotional Detachment",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "Once per long rest, you can meditate under an open sky for 10 minutes to gain advantage on one Intelligence check of your choice within the next 24 hours. The knowledge comes as flashes of cosmic understanding."
			},
			{
				"name": "Stellar Fortitude",
				"description": "You have resistance to radiant damage, and you have advantage on saving throws against effects that would banish you to another plane of existence."
			}
		],
		"personalityTraits": [
			"I look at the stars every night, as if reading messages from home.",
			"I experience the world with childlike wonderâ€”everything here is new to me.",
		...
		"ideals": [
			...
			"Transcendence. This mortal form is temporaryâ€”I will ascend beyond it. (Any)"
		],
		"bonds": [
			"I was sent here with a purpose I don't fully understand yet.",
			"A mortal showed me kindness when I first arrivedâ€”I will protect them always.",
		...
		"description": "You were born under a cosmic alignmentâ€”or perhaps you came from beyond the stars entirely, a fragment of celestial intelligence given mortal form. You possess knowledge and abilities that transcend normal mortal understanding.",
		"dangers": [
			"Cosmic Attention",
			"Stellar Obligations",
			"Humanity Drift",
	...
	},
	{
		...
		"features": [
			{
				"name": "Ancient Vigil",
				"description": "You cannot be surprised while you are conscious. You have advantage on Sense (Perception) checks to detect hidden creatures or objects in structures, ruins, or underground environments."
			},
			{
				"name": "Timeless Lore",
				"description": "You have advantage on Intelligence (History) checks, and when you encounter ancient ruins, artifacts, or inscriptions, the Decree Warden (Warden) may provide you with additional information about their origin and purpose."
			}
		],
		"personalityTraits": [
			"I measure time in centuries and find mortal urgency amusing.",
			"I speak with archaic formality that confuses modern folk.",
			"I am fiercely protective of things under my careâ€”sometimes irrationally so.",
		...
		"ideals": [
			...
			"Patience. Time reveals all truthsâ€”rushing leads to ruin. (Neutral)",
		...
		"description": "You are an ancient being tasked with protecting something of immense importance. Your long life has given you sense and perspective that few can match, but it has also left you disconnected from the rapid pace of modern times.",
		"dangers": [
			"Usurper Threats",
			"Kingdom Ghosts",
	...
	},
	{
		...
		"features": [
			{
				"name": "Royal Bearing",
				"description": "You have advantage on Presence (Persuasion) checks when negotiating with nobles, officials, and leaders. Common folk instinctively defer to you, offering respectful treatment and accommodation."
			},
			{
				"name": "Kingdom's Memory",
				"description": "You have advantage on Intelligence checks related to politics, governance, military strategy, and heraldry."
			}
		],
		"personalityTraits": [
		...
		"ideals": [
			...
			"Restoration. I will reclaim what was taken from meâ€”my kingdom and my crown. (Any)",
		...
		"bonds": [
			...
			"A prophecy foretold the fall of my kingdomâ€”and my rise from its ashes."
		],
		"flaws": [
		...
		"description": "You once ruled a kingdom that has been lost to timeâ€”whether through conquest, catastrophe, or dimensional displacement. Your crown is gone, your subjects scattered or dead, and your palace exists only in your memory. But your royal bearing and leadership experience remain.",
		"dangers": [
			"Usurper Threats",
			"Kingdom Ghosts",
			"Responsibility Weight",
	...
	},
	{
		...
		"features": [
			{
				"name": "Radiant Aura",
				"description": "You can cause your body to emit bright light in a 10-foot radius and dim light for an additional 10 feet as a bonus action. Undead and fiends within this light have disadvantage on attack rolls against you. The light lasts for 1 minute or until you dismiss it."
			},
			{
				"name": "Beacon of Hope",
				"description": "Once per long rest, you can inspire an ally within 30 feet who can see or hear you. They gain temporary hit points equal to your level + your Presence modifier and have advantage on their next saving throw."
			}
		],
		"personalityTraits": [
		...
		"ideals": [
			...
			"Hope. Even in the darkest times, light enduresâ€”I am proof of that. (Good)",
		...
		"description": "You have been chosen as a champion of radiant powerâ€”a beacon against the encroaching darkness of corrupted rifts and umbral entities. Whether anointed by a divine being, awakened through a near-death experience, or simply born with an inner light, you carry a responsibility that transcends personal ambition.",
		"dangers": [
			"Dark Retribution",
			"Hope Burden",
			"Light Dependency",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "Your words and presence uplift those around you. Once per long rest, you can spend 10 minutes performing, speaking, or simply being present to remove the frightened condition from up to 6 friendly creatures who can hear or see you."
			},
			{
				"name": "First Light",
				"description": "You have an innate connection to the concept of renewal. When you take a long rest, one ally who rests within 30 feet of you regains one additional hit die."
			}
		],
		"personalityTraits": [
			...
			"I light candles in dark placesâ€”literally and figuratively."
		],
		"ideals": [
		...
		"bonds": [
			...
			"I carry a flame that was lit at the first dawnâ€”it must never go out.",
	...
	},
	{
		...
		"features": [
			{
				"name": "Vigilant Eye",
				"description": "Your centuries of observation have honed your senses to supernatural sharpness. You have advantage on Sense (Perception) checks to notice hidden details, and you can read lips from up to 120 feet away. You also have advantage on Intelligence (Investigation) checks to spot inconsistencies or forgeries."
			},
			{
				"name": "Witnessed History",
				"description": "You have personally observed significant historical events. Once per long rest, when encountering a person, place, or object of historical significance, you can recall a relevant detail that provides advantage on your next ability check related to that subject."
			}
		],
		"personalityTraits": [
			"I observe everything and everyone, cataloging details others miss.",
			"I rarely speak firstâ€”I prefer to listen and watch.",
		...
		"bonds": [
			...
			"I watched a tragedy unfold and did nothingâ€”I carry that guilt.",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "Your travels have taught you to adapt to any environment. You can find food and fresh water for yourself and up to five other people each day in any environment, including dimensions with hostile atmospheres. You also have advantage on Sense (Survival) checks in unfamiliar terrain."
			},
			{
				"name": "Cosmic Perspective",
				"description": "Having seen the vastness of existence, you are difficult to deceive or intimidate. You have advantage on Sense (Insight) checks to determine if someone is lying, and advantage on saving throws against being frightened by creatures of CR 5 or lower."
			}
		],
		"personalityTraits": [
			"I have a story from another world for every situation.",
			"I taste everythingâ€”you never know when a local plant might be medicine.",
		...
		"ideals": [
			...
			"Purpose. I wander because I'm searching for somethingâ€”I'll know it when I find it. (Any)"
		],
		"bonds": [
			"I carry a map to a place I've never beenâ€”I was told I'd know when to use it.",
		...
		"flaws": [
			"I can never stay in one place for longâ€”wanderlust consumes me.",
	...
	},
	{
		...
		"features": [
			{
				"name": "Viral Reach",
				"description": "Your online following gives you access to information networks. You can spend 1 hour broadcasting a request to your followers to gain advantage on one Intelligence (Investigation) or Presence (Persuasion) check within the next 24 hours as your audience crowdsources answers or applies social pressure."
			},
			{
				"name": "Content Creator's Eye",
				"description": "You have an instinct for what captures attention. You have advantage on Sense (Perception) checks to notice unusual or noteworthy events happening around you."
			}
		],
		"personalityTraits": [
			"I narrate everything I do as if someone is watchingâ€”because someone usually is.",
		...
		"bonds": [
			"My first subscriber stuck with me from zeroâ€”I'd do anything for them.",
	...
	},
	{
		...
		"features": [
			{
				"name": "Stage Presence",
				"description": "Your years of idol training have given you supernatural presence. When you perform for at least 1 minute, all friendly creatures within 30 feet gain temporary hit points equal to your Presence modifier + your proficiency bonus. This can be used once per short rest."
			},
			{
				"name": "Fandom Network",
				"description": "Your devoted fan base spans the globe. In any major city, you can find a fan willing to provide shelter, information, or minor assistance within 1d4 hours of making your presence known."
			}
		],
		"personalityTraits": [
			"I maintain perfect posture and appearance at all timesâ€”training never ends.",
		...
		"ideals": [
			"Perfection. I trained 16 hours a day for yearsâ€”I refuse to accept anything less than my best. (Lawful)",
			"Inspiration. My purpose is to give people hope through my art. (Good)",
			"Freedom. The agency controlled my lifeâ€”never again. (Chaotic)",
			"Legacy. I want to be remembered for more than just a pretty face and catchy songs. (Any)"
		],
		"bonds": [
			"My former group members are scattered across different ascendant guildsâ€”I need to find them.",
			...
			"I dedicated my last song to someone who disappeared into a gateâ€”I'll find them."
		],
		"flaws": [
			"I am terrified of being seen without makeup or my stage persona.",
			"I instinctively try to please everyone, even enemies.",
			"I can't handle being ignoredâ€”I need to be the center of attention.",
			"Years of strict dieting have left me with a complicated relationship with food and rest."
		],
		"description": "You were one of the brightest stars in the entertainment industryâ€”a trained performer whose face graced billboards, whose songs topped charts, and whose every movement was choreographed to perfection. Then the Rift awakened you, and suddenly your stage presence became something far more dangerous. Your fans now watch you fight Anomalies instead of performing, and somehow, you make even that look beautiful.",
		"dangers": [
			"Paparazzi Exposure",
			"Agency Debt",
			"Sasaeng Stalkers",
	...
	},
	{
		...
		"features": [
			{
				"name": "Method Actor",
				"description": "Your acting training lets you assume identities with frightening accuracy. You have advantage on Presence (Deception) checks when impersonating a specific person you have observed for at least 10 minutes. Additionally, you can perfectly mimic accents and speech patterns."
			},
			{
				"name": "Celebrity Status",
				"description": "Your fame opens doors. You can gain access to exclusive locations, VIP areas, and high-society events. Important NPCs are more likely to grant you an audience, giving you advantage on the first Presence check when meeting someone who recognizes you."
			}
		],
		"personalityTraits": [
			"I quote my own movies in conversation and expect people to recognize the reference.",
			"I approach every situation like it's a sceneâ€”I need motivation, stakes, and a dramatic arc.",
		...
		"ideals": [
			"Art. Acting taught me empathyâ€”I've lived a thousand lives and understand them all. (Good)",
			"Power. Fame is just another word for influence, and influence changes the world. (Neutral)",
			"Authenticity. I'm tired of pretendingâ€”I want to be someone real for once. (Any)",
			"Justice. I've seen how the powerful exploit the weak, and I won't stand for it. (Lawful)"
		],
		"bonds": [
			"My stunt double was killed when a gate opened on setâ€”I carry their memory.",
		...
		"flaws": [
			"I need an audience to functionâ€”I freeze when no one is watching.",
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "Your professional training has pushed your body to its limits. You can add your proficiency bonus to Vitality saving throws against exhaustion, and you require only 4 hours of sleep to gain the benefits of a long rest."
			},
			{
				"name": "Competitive Spirit",
				"description": "When you fail an ability check or saving throw, you can choose to reroll it with advantage. You can use this feature once per long rest. Additionally, you have advantage on Athletics checks related to running, jumping, or climbing."
			}
		],
		"personalityTraits": [
			"I turn everything into a competition, even eating breakfast.",
			"I maintain a strict training regimen no matter whatâ€”6 AM runs in the dungeon if I have to.",
		...
		"ideals": [
			"Excellence. Second place is first loserâ€”I will be the absolute best. (Lawful)",
			"Teamwork. No champion wins aloneâ€”I protect my team above all else. (Good)",
			"Glory. I fight so the world will remember my name. (Neutral)",
			"Resilience. It's not about how hard you hitâ€”it's about how hard you can get hit and keep going. (Any)"
		],
		"bonds": [
			"My coach was killed by a gate beast and I fight in their memory.",
			"My old team was my familyâ€”I'd cross dimensions to protect them.",
		...
		"flaws": [
			...
			"I can't stand losingâ€”a defeat sends me into a spiral of self-doubt.",
		...
		"description": "You were at the top of your gameâ€”a professional athlete whose name was synonymous with peak human performance. Your body was a finely tuned instrument, honed through years of brutal training and competition. When the Rift awakened you, it took that foundation and built something superhuman on top of it. Now you compete on a very different field, where the losers don't go homeâ€”they don't go anywhere at all.",
		"dangers": [
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "Your business network spans industries and governments. You can call in a favor once per week to arrange meetings with powerful figures, access restricted corporate facilities, or obtain classified market information. The favor's scope is at the Warden's discretion."
			},
			{
				"name": "Hostile Negotiator",
				"description": "You are ruthlessly effective in negotiations. When you engage in a contested Presence check during negotiations, you can treat a roll of 9 or lower as a 10."
			}
		],
		"personalityTraits": [
			...
			"I always have an exit strategyâ€”for meetings, relationships, and combat."
		],
		"ideals": [
			"Order. Systems and hierarchies exist for a reasonâ€”they create efficiency. (Lawful)",
		...
		"flaws": [
			...
			"I will sacrifice almost anythingâ€”including alliesâ€”to protect my reputation.",
			"I look down on people who lack ambition or education."
		],
		"description": "Corner office, seven-figure salary, a name that made markets moveâ€”you were a titan of industry before the gates changed everything. You managed portfolios worth more than some countries' GDP and made decisions that affected millions. When the Rift awakened you, you treated it like any other hostile takeover: assess, strategize, dominate. The boardroom prepared you for battle better than anyone expected.",
		"dangers": [
			"Corporate Espionage",
			"Hostile Takeover",
			"Burnout",
	...
	},
	{
		...
		"features": [
			{
				"name": "Digital Ghost",
				"description": "You can interface with electronic systems and security networks with supernatural ease. You have advantage on Intelligence checks related to technology, hacking, or digital systems. Once per long rest, you can spend 10 minutes to access a secured digital system without leaving a trace."
			},
			{
				"name": "Dark Web Contacts",
				"description": "You have connections in the digital underground. You can spend 1 hour to contact an anonymous informant who can provide you with information about a person, organization, or location. The information is reliable but may come at a price."
			}
		],
		"personalityTraits": [
			"I see the world as systems and codeâ€”everything can be hacked if you know where to look.",
		...
		"ideals": [
			...
			"Chaos. The old systems are brokenâ€”I'm just helping them fall faster. (Chaotic)"
		],
		"bonds": [
			...
			"A fellow hacker was forcibly recruited by a umbral organizationâ€”I'm going to get them out."
		],
		"flaws": [
		...
		"description": "In the digital umbrals, you were a ghostâ€”a phantom who moved through firewalls like they were tissue paper. Governments feared your keystrokes, corporations trembled at your handle. When the Rift awakened you, you realized that reality itself was just another system to hack. The code that underlies gates, essence, and ascension looks hauntingly familiar to someone who's spent their whole life reading between the lines of code.",
		"dangers": [
	...
	},
	{
		...
		"features": [
			{
				...
				"description": "You can sway public opinion with a single post. Once per long rest, you can make a Presence (Persuasion) check to influence the attitude of a community or organization toward a person, idea, or cause. The DC is set by the Warden based on how controversial the stance is."
			},
			{
				"name": "Brand Recognition",
				"description": "Merchants and vendors recognize you. You receive a 15% discount on non-magical goods and services in any settlement with access to the internet or media networks."
			}
		],
		"personalityTraits": [
		...
		"ideals": [
			"Community. My platform connects peopleâ€”that matters more than money. (Good)",
		...
		"features": [
			{
				...
				"description": "Years of competitive gaming have trained your brain to process complex tactical information instantly. You can take the Help action as a bonus action once per short rest. Additionally, you have advantage on Intelligence checks to analyze tactical situations, traps, or puzzles."
			},
			{
				"name": "Clutch Factor",
				"description": "When the pressure is highest, you perform your best. When you are at half hit points or below, you gain a +2 bonus to attack rolls and saving throws. This represents your ability to perform in clutch moments."
			}
		],
		"personalityTraits": [
			...
			"I treat real combat encounters like raid bossesâ€”I need strategy, roles, and a shot caller.",
			"I use gaming terminology for everything: 'aggro,' 'DPS,' 'tank,' 'res me.'"
		],
		"ideals": [
			"Strategy. Every problem has an optimal solutionâ€”you just have to find it. (Lawful)",
			"Competition. I don't just want to winâ€”I want to be the undisputed best. (Neutral)",
