...
export const items_part9: Item[] = [
	{
		...
		tags: ["equipment", "radiant", "buff", "ice"],
	...
	},
	{
		...
		tags: ["equipment", "shadow", "area", "necrotic"],
	...
	},
	{
		...
		discovery_lore:
			"Located by a detection-type Hunter whose radar ability triggered on an otherwise empty room.",
		tags: ["equipment", "burst", "necrotic", "buff", "offensive"],
	...
	},
	{
		...
		tags: ["equipment", "damage", "healing", "area", "necrotic"],
	...
	},
	{
		...
		discovery_lore:
			"Located by a detection-type Hunter whose radar ability triggered on an otherwise empty room.",
		tags: ["equipment", "fire", "sustained", "healing", "stealth"],
	...
	},
	{
		...
		discovery_lore:
			"Found pulsing with residual mana in the aftermath of a Gate break, half-buried in shattered concrete.",
		tags: ["equipment", "shadow", "burst", "stealth", "void"],
	...
	},
	{
		...
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "healing", "lightning", "sustained"],
	...
	},
	{
		...
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "offensive", "perception"],
	...
	},
	{
		...
		tags: ["equipment", "sustained", "utility", "fire", "damage"],
	...
	},
	{
		...
		tags: ["equipment", "shadow", "defensive", "damage"],
	...
	},
	{
		...
		discovery_lore:
			"Traded by a nomadic Awakened who claimed to have no memory of acquiring it.",
		tags: ["equipment", "mobility", "void", "utility"],
	...
	},
	{
		...
		discovery_lore:
			"Materialized on a Hunter's workbench overnight, leaving scorch marks in the shape of unknown glyphs.",
		tags: ["equipment", "ice", "offensive", "defensive"],
	...
	},
	{
		...
		tags: ["equipment", "area", "perception", "buff", "psychic"],
	...
	},
	{
		...
		discovery_lore:
			"Dropped by a mini-boss that shouldn't have existed according to the Gate's difficulty rating.",
		tags: ["equipment", "perception", "support", "buff"],
	...
	},
	{
		...
		discovery_lore:
			"Found pulsing with residual mana in the aftermath of a Gate break, half-buried in shattered concrete.",
		tags: ["equipment", "control", "psychic", "area"],
	...
	},
	{
		...
		discovery_lore:
			"Recovered from a time-locked chest that required three different elemental keys to open.",
		tags: ["equipment", "defensive", "healing"],
	...
	},
	{
		...
		discovery_lore:
			"Recovered from a time-locked chest that required three different elemental keys to open.",
		tags: ["equipment", "ice", "sustained", "stealth", "lightning"],
	...
	},
	{
		...
		discovery_lore:
			"Sold by a mysterious merchant who appears only during full moons near active Gate sites.",
		tags: ["equipment", "debuff", "lightning", "radiant", "psychic"],
	...
	},
	{
		...
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "damage", "support", "psychic"],
	...
	},
	{
		...
		discovery_lore:
			"Discovered by an E-Rank Hunter who stumbled into an unmarked side passage during a routine dungeon clear.",
		tags: ["equipment", "psychic", "radiant"],
	...
	},
	{
		...
		discovery_lore:
			"Sold by a mysterious merchant who appears only during full moons near active Gate sites.",
		tags: ["equipment", "defensive", "radiant", "single-target"],
	...
	},
	{
		...
		tags: ["equipment", "support", "debuff", "radiant", "ice"],
	...
	},
	{
		...
		discovery_lore:
			"Excavated from the crystallized mana deposit at the center of a depleted Gate core.",
		tags: ["equipment", "control", "shadow", "burst"],
	...
	},
	{
		...
		discovery_lore:
			"Traded by a nomadic Awakened who claimed to have no memory of acquiring it.",
		tags: ["equipment", "single-target", "debuff", "shadow", "void"],
	...
	},
	{
		...
		discovery_lore:
			"Sold by a mysterious merchant who appears only during full moons near active Gate sites.",
		tags: ["equipment", "support", "stealth"],
