...
export const artifacts: Artifact[] = [
	// DIVINE WEAPONS
	{
		...
		description:
			"The legendary blade of the Umbral Regent, capable of cutting through dimensions.",
		type: "weapon",
		rarity: "divine",
		attunement: true,
		requirements: {
		...
		abilities: {
			...
			secondary: {
				...
				description:
					"Teleport through shadows within 120 feet as a bonus action.",
				type: "active",
				frequency: "at-will",
				action: "bonus-action",
			},
			...
			ultimate: {
				...
				description:
					"Erase a creature from existence, preventing any form of revival.",
				type: "active",
		...
		lore: {
			...
			history:
				"This blade has passed through countless hands, each wielder becoming a legend.",
			personality:
				"The blade speaks in whispers of shadows and secrets, offering power at a cost.",
	...
	},
	{
		...
		lore: {
			origin:
				"Created by the first dragon god from the essence of all dragons.",
	...
	},
	{
		...
		mechanics: {
			...
			special: [
				"Cannot be affected by time magic",
	...
	// LEGENDARY RELICS
	{
		...
		lore: {
			...
			personality:
				"The gauntlets speak with the authority of countless rulers.",
