...
const dmTools = [
	...
	},
	{
		...
		description:
			"Generate branching quests with objectives, complications, and rewards.",
		icon: Scroll,
		status: "available",
		color:
					...
					<div className="flex items-center justify-between">
						...
						<div className="flex items-center gap-2">
							...
							<Button
								variant="outline"
								size="sm"
								onClick={() => navigate("/dm-tools/system-console")}
							>
						...
						<CardContent>
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
								<Button
									...
									onClick={() => navigate("/dm-tools/encounter-builder")}
								>
								...
								<Button
									variant="outline"
									className="justify-start"
									onClick={() => navigate("/dm-tools/random-event-generator")}
								>
								...
								<Button
									variant="outline"
									className="justify-start"
									onClick={() => navigate("/dm-tools/party-tracker")}
								>
								...
								<Button
									variant="outline"
									className="justify-start"
									onClick={() => navigate("/dm-tools/session-planner")}
								>
