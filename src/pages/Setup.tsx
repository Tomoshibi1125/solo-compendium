					...
					<div className="space-y-4">
						...
						<div className="space-y-2 text-sm">
							...
							<ol className="list-decimal pl-5 space-y-1 text-muted-foreground">
								...
								<li>
									For runtime config, update <code>public/runtime-env.js</code>{" "}
									before serving.
								</li>
							</ol>
						</div>
						...
						<div className="text-xs text-muted-foreground">
							...
							<ul className="list-disc pl-5 mt-1 space-y-1">
								<li>
									<code>docs/DEPLOY_CHECKLIST.md</code>
								</li>
								<li>
									<code>docs/DEPLOYMENT_READINESS.md</code>
								</li>
								<li>
									<code>scripts/SUPABASE_SETUP.md</code>
								</li>
							</ul>
						</div>
					</div>
