...
const VTTEnhanced = () => {
	...
	const isWarden = role === "system" || role === "co-warden";
	...
	const handleMapKeyDown = useCallback(
		(e: React.KeyboardEvent<HTMLDivElement>) => {
			...
			// Delete/Backspace — remove active token (PW only)
			if (
	...
	const overlayStyles = useMemo(() => {
		...
		drawingsToRender.forEach((drawing) => {
			if (drawing.layer === "PW" && !isWarden) return;
					...
					<>
						...
						>
							...
							>
								...
								{/* Comprehensive Protocol Warden Tools Panel */}
								{isWarden && (
									<ProtocolWardenTools
										campaignId={campaignId || ""}
													...
													<div>
														...
														>
															...
															<SelectContent>
																...
																<SelectItem value="PW">PW Only</SelectItem>
															</SelectContent>
														</Select>
													</div>
												</div>
