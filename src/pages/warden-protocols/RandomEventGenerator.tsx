...
const NPC_ENCOUNTERS: { description: string; impact: string }[] = [
	...
	{
		description:
			"Rogue AI Fragment: A fragmented holographic entity appearing as a distorted version of the party's Protocol Warden.",
		impact:
...
const RandomEventGenerator = () => {
	...
	const {
		...
		storageKey: "solo-compendium.PW-tools.random-event-generator.v1",
	});
