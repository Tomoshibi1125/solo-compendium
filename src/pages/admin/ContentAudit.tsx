							...
							.map((table) => (
								...
								>
									...
									<td className="text-right p-2">
										...
										{Math.round(
											(table.withDescription / table.totalCount) * 100,
										)}
										%)
									</td>
									<td className="text-right p-2">
										{table.withImage} (
										{Math.round((table.withImage / table.totalCount) * 100)}%)
									</td>
									<td className="text-right p-2">
										{table.withSourceBook} (
										{Math.round(
											(table.withSourceBook / table.totalCount) * 100,
										)}
										%)
									</td>
									<td className="text-right p-2">
			...
			<div className="space-y-4">
				...
				<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
					<div>
						...
						<div className="text-lg font-bold">
							{integrityReport.totalCharacters}
						</div>
					</div>
					<div>
						<div className="text-xs text-muted-foreground">
				...
				{hasBrokenLinks && (
					<div className="space-y-2">
						...
						<div className="flex flex-wrap gap-2">
							{Object.entries(integrityReport.brokenLinksByType).map(
								([type, count]) => (
