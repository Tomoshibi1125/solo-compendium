    ...
    try {
      ...
      img.onload = () => {
        ...
        canvas.toBlob(async (blob) => {
          ...
          setNewToken((prev: Partial<Token>) => ({ ...prev, imageUrl: publicUrl }));
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      ref={nameInputRef}
                      value={newToken.name || ''}
                      onChange={(e) => setNewToken((prev: Partial<Token>) => ({ ...prev, name: e.target.value }))}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select value={newToken.type} onValueChange={(value) => setNewToken((prev: Partial<Token>) => ({ ...prev, type: value as Token['type'] }))}>
                    ...
                    <div>
                      ...
                      <Select value={newToken.category} onValueChange={(value) => setNewToken((prev: Partial<Token>) => ({ ...prev, category: value as Token['category'] }))}>
                        <SelectTrigger className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select value={newToken.size} onValueChange={(value) => setNewToken((prev: Partial<Token>) => ({ ...prev, size: value as Token['size'] }))}>
                        <SelectTrigger className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewToken((prev: Partial<Token>) => ({ ...prev, emoji: e.target.value }))}
                        placeholder="🗡️"
                        maxLength={2}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setNewToken((prev: Partial<Token>) => ({ ...prev, color: e.target.value }))}
                            ...
                            <div className="flex flex-col items-center gap-3">
                              ...
                              <div className="text-center w-full">
                                ...
                                <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
                                  ...
                                  <Badge variant="outline">{getCategoryLabel(token.category)}</Badge>
