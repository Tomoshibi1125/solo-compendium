...
const compendiumCategories = [
  {
    name: 'Jobs',
    description: 'Ascendant classes and progression paths',
    icon: Swords,
  ...
  {
    name: 'Monsters',
    description: 'Rift creatures and bosses',
    icon: Skull,
    href: '/compendium?category=monsters',
    color: 'from-red-500/20 to-red-600/10 border-red-500/30 hover:border-red-400/50',
    count: 200,
  },
  {
    name: 'Conditions',
    description: 'Status effects and system states',
    icon: AlertTriangle,
  ...
  {
    name: 'Locations',
    description: 'Rift zones, cities, and ruins',
    icon: MapPin,
