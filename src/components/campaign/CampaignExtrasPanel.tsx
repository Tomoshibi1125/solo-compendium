...
export function CampaignExtrasPanel({ campaignId, isDM }: CampaignExtrasPanelProps) {
    const { extras, addExtra, updateExtra, removeExtra, isLoading } = useCampaignExtras(campaignId);
                                    ...
                                    <div className="flex items-center gap-3">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="font-display text-lg w-12 text-center">{extra.hp_current}/{extra.hp_max}</span>
                                                <Button
                                                    variant="outline"
                                                    size="sm"
                                                    className="h-6 w-6 p-0"
