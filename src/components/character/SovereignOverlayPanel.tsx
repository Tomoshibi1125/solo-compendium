import { Crown, Zap, Shield, Star, ChevronDown, ChevronUp, Lock } from 'lucide-react';
...
function AbilityCard({ ability, index }: { ability: FusionAbility; index: number }) {
                ...
                <div className="mt-2 space-y-1">
                    {ability.recharge && (
                        <p className="text-xs text-muted-foreground">
                            <span className="font-semibold">Recharge:</span> {ability.recharge}
                        </p>
                    )}
                    {ability.level > 0 && (
                        <p className="text-xs text-muted-foreground">
                            <span className="font-semibold">Unlock Level:</span> {ability.level}
                        </p>
                    )}
...
export function SovereignOverlayPanel({ characterId }: SovereignOverlayPanelProps) {
            ...
            <SystemWindow title="SOVEREIGN OVERLAY">
                <div className="flex items-center gap-3 text-muted-foreground text-sm py-2">
                    ...
                    <p>
                        ...
                        <span className="text-arise-violet font-semibold">Gemini Protocol</span> once you have{' '}
                        unlocked two Regents.
                    </p>
                </div>
            </SystemWindow>
        );
            ...
            <div className="space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground italic mt-0.5">{sovereign.title}</p>
                    </div>
                    ...
                    <>
                        ...
                        <div>
                            <div className="flex items-center gap-2 mb-1.5">
                                ...
                                <p className="text-xs font-semibold text-arise-violet tracking-wider uppercase">Combat Doctrine</p>
                            </div>
                            <p className="text-sm text-muted-foreground leading-relaxed">
                                {sovereign.fusion_description}
                            </p>
