			...
			<SystemWindow title="Umbral Legion" variant="regent">
				<div className="text-center py-8">
					...
					<p className="text-sm text-muted-foreground">
						Unlock the <span className="text-shadow-purple">{umbralTitle}</span>{" "}
				...
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<p className="font-display text-lg text-shadow-purple">
								{mySoldiers.length} Legionnaires
							</p>
						</div>
					</div>
					<Badge
				...
				{mySoldiers.length > 0 ? (
					<div className="space-y-3">
						{mySoldiers.map((css, index) => {
							...
							const typeData = typeIcons[soldier.shadow_type] || {
										...
										<div className="flex items-center gap-3">
											...
											<div>
												<div className="flex items-center gap-2">
													<span
														className={cn(
															...
															css.is_summoned && "text-shadow-purple",
														)}
													>
														{formatRegentVernacular(
												...
												<p className="text-xs text-muted-foreground italic">
													{formatRegentVernacular(soldier.title)}
												</p>
											</div>
										</div>
										<Button
											...
											onClick={() => {
												...
												const actionText = !css.is_summoned
													? "Summons"
													: "Dismisses";
												const soldierName = formatRegentVernacular(
													css.nickname || soldier.name,
												);
														...
														<div className="flex items-center gap-3">
															...
															<div>
																<CardTitle className="text-lg font-heading">
																	{formatRegentVernacular(soldier.name)}
																</CardTitle>
