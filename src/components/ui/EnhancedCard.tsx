...
const cardVariants = {
  ...
  sovereign: "bg-gradient-to-br from-regent-gold/20 via-shadow-purple/15 to-void-black/90 text-white border-regent-gold/40 shadow-[0_0_25px_hsl(var(--regent-gold)/0.3)] hover:shadow-[0_0_40px_hsl(var(--regent-gold)/0.5)] hover:scale-[1.03] transition-all duration-500 regent-seal",
