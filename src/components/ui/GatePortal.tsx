...
const rankColors = {
	...
	D: {
		outer: "hsl(35 85% 50%)",
		inner: "hsl(35 85% 40%)",
		glow: "hsl(35 85% 50% / 0.4)",
	},
	C: {
		outer: "hsl(195 85% 50%)",
		inner: "hsl(195 85% 40%)",
		glow: "hsl(195 85% 50% / 0.4)",
	},
	B: {
		outer: "hsl(275 75% 55%)",
		inner: "hsl(275 75% 45%)",
		glow: "hsl(275 75% 55% / 0.5)",
	},
	A: {
		outer: "hsl(0 90% 55%)",
		inner: "hsl(0 90% 45%)",
		glow: "hsl(0 90% 55% / 0.5)",
	},
	S: {
		outer: "hsl(42 100% 55%)",
		inner: "hsl(42 100% 45%)",
		glow: "hsl(42 100% 55% / 0.6)",
	},
	SS: {
		outer: "hsl(265 100% 70%)",
		inner: "hsl(280 85% 60%)",
		glow: "hsl(265 100% 70% / 0.7)",
	},
	NATIONAL: {
		outer: "hsl(220 100% 65%)",
		inner: "hsl(220 100% 55%)",
		glow: "hsl(220 100% 65% / 0.7)",
	},
};
