				...
				<div className="flex items-start gap-4">
					...
					<div className="flex-1 min-w-0">
						<h3 className="font-semibold mb-1 flex items-center gap-2">
							...
							Help Improve Rift Ascendant
						</h3>
						<p className="text-sm text-muted-foreground mb-3">
							We use privacy-respecting analytics to understand how you use the
							app and improve it. No personal data is collected, and you can opt
							out at any time. Analytics are completely optional.
						</p>
