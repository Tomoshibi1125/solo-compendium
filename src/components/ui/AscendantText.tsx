...
interface RiftHeadingProps {
	children: ReactNode;
	level?: 1 | 2 | 3 | 4 | 5 | 6;
	variant?: "rift" | "sovereign" | "rift" | "gate" | "shadow";
	dimensional?: boolean;
	className?: string;
}

export const RiftHeading = ({
	children,
	level = 1,
	variant = "rift",
	dimensional = false,
...
interface ManaFlowTextProps {
	children: ReactNode;
	variant?: "rift" | "sovereign" | "rift";
	speed?: "slow" | "normal" | "fast";
	className?: string;
}

export const ManaFlowText = ({
	children,
	variant = "rift",
	className,
}: ManaFlowTextProps) => {
	...
	return (
		<span
			className={cn(
				"font-heading font-medium tracking-wider",
				styles.color,
				className,
			)}
			style={{
