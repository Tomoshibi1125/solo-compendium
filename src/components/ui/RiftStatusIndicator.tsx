...
export const RiftStatusIndicator = ({
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      ctx.lineWidth = 6;
      ctx.beginPath();
      ctx.arc(centerX, centerY, radius * 0.8, -Math.PI / 2, -Math.PI / 2 + (stability / 100) * Math.PI * 2);
      ctx.stroke();
  ...
  return (
    <div className={cn("relative bg-void-black/80 border border-gate-s/30 rounded-lg p-4", className)}>
      {/* Header */}
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-2 text-xs">
            <div className="text-center">
              ...
              <div className="font-mono text-white">{coordinates.x.toFixed(1)}</div>
            </div>
            <div className="text-center">
              <div className="font-system text-gate-s">Y</div>
              <div className="font-mono text-white">{coordinates.y.toFixed(1)}</div>
            </div>
            <div className="text-center">
              <div className="font-system text-gate-s">Z</div>
              <div className="font-mono text-white">{coordinates.z.toFixed(1)}</div>
            </div>
          </div>
          <div className="text-center">
