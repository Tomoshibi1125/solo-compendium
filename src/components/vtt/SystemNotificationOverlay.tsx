...
// System Ascendant Themes (Amethyst/Obsidian/Crimson/Warden)
const THEMES: Record<
	BroadcastTheme,
	{
...
interface SystemNotificationOverlayProps {
	notifications: BroadcastPayload[];
	onDismiss: (id: string) => void;
}

export const SystemNotificationOverlay: React.FC<
	SystemNotificationOverlayProps
> = ({ notifications, onDismiss }) => {
	...
	useEffect(() => {
		if (notifications.length > 0 && !activeNote) {
			...
			// Play sound
			const theme =
				THEMES[next.message_type as BroadcastTheme] || THEMES.system;
					...
					>
						...
						<div className="relative p-6 px-10 flex flex-col items-center">
							...
							<p className="text-[0.7rem] italic text-muted-foreground opacity-70">
								Transmission secured from: {activeNote.sender_name || "System"}
							</p>
