...
import DungeonMapGenerator from "@/pages/warden-protocols/DungeonMapGenerator";
import EncounterBuilder from "@/pages/warden-protocols/EncounterBuilder";
import GateGenerator from "@/pages/warden-protocols/GateGenerator";
import NPCGenerator from "@/pages/warden-protocols/NPCGenerator";
import RandomEventGenerator from "@/pages/warden-protocols/RandomEventGenerator";
import RelicWorkshop from "@/pages/warden-protocols/RelicWorkshop";
import RollableTables from "@/pages/warden-protocols/RollableTables";
import TreasureGenerator from "@/pages/warden-protocols/TreasureGenerator";
				...
				<SystemWindow title="QUICK ACTIONS" compact>
					...
					{macros.length > 0 && (
						<div className="space-y-2 pt-2 border-t border-border/50">
							<Label className="text-xs">Saved Macros</Label>
						...
						<TabsContent value="generators" className="space-y-4">
							...
							<div className="grid grid-cols-2 gap-4">
								...
								<Dialog>
									...
									<DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
										<DialogHeader>
											<DialogTitle>Directive Matrix</DialogTitle>
										</DialogHeader>
										<DirectiveMatrix />
									</DialogContent>
								</Dialog>
