...
export type DiceTheme = 'shadow-monarch' | 'supreme-deity' | 'gate-portal' | 'system-interface' | 'arise-violet' | 'monarch-gold';
...
const DICE_THEMES: Record<DiceTheme, DiceThemeConfig> = {
  'shadow-monarch': {
    baseColor: '#8b5cf6',
