						...
						{user ? (
							<DropdownMenu>
								<DropdownMenuTrigger asChild>
									<Button
										variant="ghost"
										className="relative h-9 w-9 rounded-full min-h-[44px] min-w-[44px]"
									>
			...
			{mobileMenuOpen && (
				...
				>
					...
					<nav className="fixed top-14 right-0 bottom-0 w-72 sm:w-80 bg-background border-l border-border overflow-y-auto p-4 space-y-1 animate-in slide-in-from-right duration-200">
						...
						<Link
							to="/characters"
							className={mobileNavLinkClass("/characters")}
							onClick={closeMobileMenu}
						>
						...
						<Link
							to="/compendium"
							className={mobileNavLinkClass("/compendium")}
							onClick={closeMobileMenu}
						>
						...
						<Link
							to="/campaigns"
							className={mobileNavLinkClass("/campaigns")}
							onClick={closeMobileMenu}
						>
						...
						<Link
							to="/player-tools"
							className={mobileNavLinkClass("/player-tools")}
							onClick={closeMobileMenu}
						>
						...
						<Link
							to="/dm-tools"
							className={mobileNavLinkClass("/dm-tools")}
							onClick={closeMobileMenu}
						>
						...
						<Link
							to="/dice"
							className={mobileNavLinkClass("/dice")}
							onClick={closeMobileMenu}
						>
							<Dice6 className="h-4 w-4 flex-shrink-0" />
							Dice Roller
						</Link>
						<Link
							to="/favorites"
						...
						<Link
							to="/homebrew"
							className={mobileNavLinkClass("/homebrew")}
							onClick={closeMobileMenu}
						>
