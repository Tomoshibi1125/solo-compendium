...
export function NavBar() {
    ...
    const isAuthPage = location.pathname.startsWith('/login') || location.pathname.startsWith('/auth') || location.pathname.startsWith('/setup');
                ...
                <div className="flex h-16 items-center justify-between px-4 lg:px-8">
                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        ...
                        {user ? (
                            ...
                            <Button onClick={() => navigate("/login")} variant="arise" size="sm" className="hidden sm:flex font-bold tracking-wide">
                                Login
                            </Button>
                        )}
                    </div>
