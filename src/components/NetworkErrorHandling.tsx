	...
	return (
		<Alert className="border-yellow-200 bg-yellow-50">
			...
			<AlertDescription className="text-yellow-800">
				<strong>Slow Network Detected:</strong> Loading may take longer than
				usual. Your connection appears to be slower than expected.
			</AlertDescription>
		</Alert>
	);
}
			...
			<CardContent className="space-y-4">
				...
				<div className="space-y-2">
					<p className="text-sm text-red-700">
						Our servers are experiencing difficulties. This is usually temporary
			...
			<CardContent className="space-y-4">
				<Alert className="border-orange-200">
					...
					<AlertDescription className="text-orange-800">
						The request took too long to complete. This may be due to network
				...
				<div className="space-y-2">
					<p className="text-sm text-orange-700">
						The server didn't respond in time. This usually happens during high
						traffic periods.
					</p>
				</div>
	...
	return (
		<Alert className="border-gray-200 bg-gray-50">
			...
			<AlertDescription className="text-gray-800">
				<strong>Offline Mode:</strong> You're currently offline. Some features
			...
			<CardContent className="p-4">
				<div className="flex items-center gap-3">
					...
					<div className="flex-1">
						...
						<p className="text-sm text-red-600">Failed to load: {resource}</p>
					</div>
