    ...
    <div className="flex items-center justify-between rounded-lg border border-violet-300 bg-violet-50/80 px-4 py-2">
      <div className="flex items-center gap-2">
        ...
        {remainingRounds !== undefined && remainingRounds > 0 && (
          <span className="text-xs text-violet-500">({remainingRounds} rounds)</span>
        )}
      </div>
      <Button size="sm" variant="ghost" onClick={onDrop} className="h-6 w-6 p-0 text-violet-500 hover:text-violet-700">
