  ...
  return (
    <div className="rounded-lg border border-red-300 bg-red-50/80 p-4 space-y-3">
      <div className="flex items-center justify-between">
        ...
        {isDead && (
          <span className="text-xs font-bold text-red-600 uppercase tracking-wider">Dead</span>
        )}
        {isStable && !isDead && (
      ...
      <div className="flex items-center gap-6">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="flex items-center gap-1.5">
                <span className="text-xs font-medium text-green-700">Successes</span>
        ...
        <TooltipProvider>
          <Tooltip>
            <TooltipTrigger asChild>
              <div className="flex items-center gap-1.5">
                <span className="text-xs font-medium text-red-700">Failures</span>
                <div className="flex gap-1">
                  {[0, 1, 2].map((i) => (
                    <div
                      key={`f-${i}`}
