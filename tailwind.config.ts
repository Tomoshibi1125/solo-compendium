  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-system": "linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(220 100% 60%) 100%)",
        "gradient-shadow": "linear-gradient(135deg, hsl(var(--secondary)) 0%, hsl(280 70% 35%) 100%)",
      },
    },
  },
