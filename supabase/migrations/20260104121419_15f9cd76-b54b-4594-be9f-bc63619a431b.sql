...
(
  ...
  'The Crimson Knight',
  'Marshal Grade',
  'The first and most loyal of the Shadow Soldiers. A crimson-armored knight who once served as a boss monster before being extracted as a shadow. Igris wields an impossibly large greatsword with unmatched skill and serves as the commander of all shadow soldiers in battle.',
  'Formerly known as the Blood-Red Knight, Igris was the guardian of the Double Dungeon''s inner sanctum. After a fierce battle, he was extracted by the Supreme Deity and became the most trusted shadow soldier. His loyalty is absolute, and he would sacrifice himself a thousand times for the cause.',
  22, 18, 20, 14, 16, 12,
  20, 250, 40,
  ARRAY['necrotic', 'poison'],
  ARRAY['frightened', 'charmed', 'exhaustion'],
  '[{"name": "Crimson Slash", "description": "Melee Weapon Attack: +12 to hit, reach 10 ft. Deals 4d10+8 slashing damage plus 2d8 necrotic damage. On a critical hit, the target must make a DC 18 Constitution save or be stunned until the end of their next turn.", "action_type": "action"}, {"name": "Knight Commander", "description": "As a bonus action, Igris can command up to 3 other shadow soldiers within 60 feet to immediately make one weapon attack.", "action_type": "bonus action"}, {"name": "Undying Loyalty", "description": "When Igris would be reduced to 0 HP, he instead drops to 1 HP. This can only occur once per long rest.", "action_type": "reaction"}]'::jsonb,
  'knight',
  'Shadow Monarch unlock + Shadow-themed Sovereign + Level 10+'
),
(
  'Beru',
  'The Ant King',
  'Marshal Grade',
  'An insectoid shadow soldier with terrifying power. Originally the Ant King who killed countless S-Rank hunters, Beru''s extraction was a turning point. He speaks formally and has a taste for the finer things, but his combat prowess is apocalyptic.',
  'The terror of Jeju Island, Beru slaughtered an elite team of hunters before facing the Supreme Deity. After his defeat and extraction, he became fanatically devoted to the divine cause, serving with predatory enthusiasm and unwavering loyalty.',
  24, 20, 22, 12, 14, 8,
  22, 300, 50,
  ARRAY['necrotic', 'poison', 'acid'],
  ARRAY['frightened', 'paralyzed', 'exhaustion'],
  '[{"name": "Devastating Claw", "description": "Melee Weapon Attack: +14 to hit, reach 15 ft. Deals 5d10+10 slashing damage. Can attack twice as part of the same action.", "action_type": "action"}, {"name": "Devour", "description": "When Beru reduces a creature to 0 HP, he can devour it as a bonus action to gain temporary HP equal to the creature''s maximum HP (max 50). He also gains one ability the creature possessed for 1 hour.", "action_type": "bonus action"}, {"name": "Regeneration", "description": "Beru regains 20 HP at the start of each of his turns if he has at least 1 HP.", "action_type": "passive"}]'::jsonb,
  'insect',
  'Shadow Monarch unlock + Shadow-themed Sovereign + Level 14+'
),
(
  'Iron',
  'The Mining Mage',
  'Knight Grade',
  'A massive armored shadow soldier who excels at taking hits. Iron served as a tank in the Supreme Deity''s shadow army, protecting weaker soldiers and holding defensive lines. His pickaxe can both mine resources and crush enemies.',
...
(
  ...
  'The High Orc Shadow',
  'Elite Knight Grade',
  'A fearsome high orc shadow soldier with incredible regenerative abilities. Tusk leads shadow orc packs into battle, overwhelming enemies with savage fury and numbers.',
  'Once a dungeon boss, the High Orc Tusk joined the shadow army after a brutal conquest. He maintains some of his orc battle-lust but channels it entirely for his master''s will.',
  22, 16, 22, 10, 14, 10,
  18, 180, 35,
  ARRAY['necrotic', 'poison'],
  ARRAY['frightened', 'charmed'],
  '[{"name": "Savage Assault", "description": "Melee Weapon Attack: +11 to hit, reach 10 ft. Deals 3d12+7 slashing damage. If Tusk moves at least 20 feet in a straight line before attacking, the target takes an additional 2d12 damage.", "action_type": "action"}, {"name": "Battle Cry", "description": "As a bonus action, Tusk lets out a war cry. All shadow soldiers within 30 feet gain advantage on their next attack roll.", "action_type": "bonus action"}, {"name": "Relentless", "description": "When Tusk is reduced to 0 HP but not killed outright, he drops to 1 HP instead. This can be used once per short rest.", "action_type": "passive"}]'::jsonb,
  'berserker',
  'Shadow Monarch unlock + Shadow-themed Sovereign + Level 5+'
),
(
  'Tank',
  'The Ice Bear',
