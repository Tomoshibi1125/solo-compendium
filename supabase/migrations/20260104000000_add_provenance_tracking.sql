...
ADD COLUMN IF NOT EXISTS source_name TEXT DEFAULT 'System Ascendant Homebrew',
...
COMMENT ON COLUMN public.compendium_jobs.source_name IS 'Name of the source (e.g., "System Ascendant Homebrew", "5e SRD", "Generated Gap-Fill")';
