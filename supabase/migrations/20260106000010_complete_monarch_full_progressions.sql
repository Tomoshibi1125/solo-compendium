...
-- =============================================
-- Based on actual Solo Leveling manhwa monarchs
-- Full class progressions reflecting Jinwoo's Shadow Monarch power scaling
-- Each monarch gets features at EVERY level 1-20, like a full class
-- All aligned with Solo Leveling lore and actual monarch abilities

-- =============================================
-- SHADOW MONARCH - Full Progression (1-20)
-- =============================================
-- Based on Jinwoo's actual powers and progression in Solo Leveling
...
'At 7th level, you gain the signature ability of the Shadow Monarch: the power to extract shadows from the dead. When you slay a creature with a challenge rating equal to or less than your level, you can use your reaction to extract its shadow. The shadow rises as a shadow soldier under your command within 30 feet of you. The shadow soldier uses the statistics of the creature it was extracted from, but it is an undead creature of the shadow type. It obeys your verbal commands and acts on your turn in initiative. You can have a number of shadow soldiers equal to your proficiency bonus. If you extract a shadow when you have the maximum, the oldest shadow soldier is destroyed. Shadow soldiers last until destroyed or dismissed as a bonus action. This is the power that made Jinwoo unstoppable.',
...
'At 9th level, you can swap places with your shadow soldiers instantly. As an action, you can teleport to a space occupied by one of your shadow soldiers within 120 feet, and that shadow soldier teleports to your previous space. This doesn''t provoke opportunity attacks. You can use this feature a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest. This ability allows tactical positioning like Jinwoo used in battle.',
...
'Starting at 10th level, you can store shadow soldiers in your shadow realm. As a bonus action, you can dismiss any number of your shadow soldiers into storage. They remain in storage indefinitely and can be summoned back as a bonus action. While in storage, shadow soldiers don''t count toward your maximum limit. You can have a total number of stored and active shadow soldiers equal to twice your proficiency bonus. This allows you to maintain a reserve army like Jinwoo did.',
...
'At 11th level, you can command your entire shadow army simultaneously. As a bonus action, you can command all your shadow soldiers within 120 feet to take the same action (Attack, Dash, Disengage, Dodge, or Help). Additionally, the maximum number of active shadow soldiers you can control increases to twice your proficiency bonus. Your shadow soldiers have advantage on attack rolls when they outnumber their target. This represents your mastery over shadow tactics.',
...
'Starting at 12th level, you can create a domain of shadow around you. As an action, you create a 20-foot-radius sphere of shadow centered on yourself. The sphere spreads around corners and is heavily obscured for creatures other than you and your shadow soldiers. It lasts for 1 minute or until you dismiss it as a bonus action. While the domain is active, you and your shadow soldiers have advantage on attack rolls, and enemies have disadvantage on attack rolls against you. You can use this feature once per long rest.',
...
'At 17th level, your shadow soldiers become truly eternal. When a shadow soldier is reduced to 0 hit points, it doesn''t die immediately. Instead, it becomes shadowy mist and reforms at the start of your next turn with half its hit point maximum. A shadow soldier can only be permanently destroyed if it is reduced to 0 hit points by radiant damage or if you dismiss it. Additionally, your maximum active shadow soldiers increases to three times your proficiency bonus. Your army becomes unstoppable, like Jinwoo''s legendary shadow legion.',
...
'At 20th level, you have achieved the full power of the Shadow Monarch, matching the authority that Jinwoo held. You can extract shadows from any creature you slay, regardless of size or type, and you can maintain an unlimited number of shadow soldiers. Additionally, you can use your action to command all undead creatures within 1 mile of you, with no limit on challenge rating. They must make a Wisdom saving throw (DC = 8 + your proficiency bonus + your Presence modifier) or fall under your control permanently until you release them. You can use this mass command once per long rest. You have become the true Monarch of Shadows, with power that rivals the System itself. Arise.',
...
-- =============================================
-- Power level equal to Shadow Monarch, themed around primal transformation and beast mastery
-- Based on Solo Leveling lore: Apex predator, transformation, command over beasts
...
'At 20th level, you have achieved the full power of the Beast Monarch, matching the authority of the Shadow Monarch. You can charm an unlimited number of beasts and monstrosities, and they retain all their abilities and statistics. Additionally, you can use your action to command all beasts and monstrosities within 1 mile of you, with no limit on challenge rating. They must make a Wisdom saving throw (DC = 8 + your proficiency bonus + your Presence modifier) or fall under your control permanently until you release them. You can use this mass command once per long rest. You have become the true Monarch of Beasts, with power that commands all creatures. All beasts bow before the apex predator.',
