-- Resolve remaining Supabase lint issues

-- 1) Fix daily quest function ambiguity by renaming variables
...
-- 2) Clean loop variable warnings in join code generator
...
-- 3) Qualify columns in AI usage stats to avoid ambiguity
...
-- 4) Use parameters in enhance_art_prompt to satisfy linter
