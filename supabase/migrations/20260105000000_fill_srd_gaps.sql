...
('Toll the Dead', 0, '1 action', '60 feet', 'Instantaneous', 'You point at one creature you can see within range, and the sound of a dolorous bell fills the air around it for a moment. The target must succeed on a Sense saving throw (DC = 8 + your proficiency bonus + your spellcasting ability modifier) or take 1d8 necrotic damage. If the target is missing any of its hit points, it instead takes 1d12 necrotic damage. The power''s damage increases by one die when you reach 5th level (2d8 or 2d12), 11th level (3d8 or 3d12), and 17th level (4d8 or 4d12).', false, false, 'Necromancy', 'V, S', ARRAY[], ARRAY['damage', 'cantrip'], 'SRD', 'srd', '5e SRD', 'Open Game License content')
...
('Animal Friendship', 1, '1 action', '30 feet', '24 hours', 'This power lets you convince a beast that you mean it no harm. Choose a beast that you can see within range. It must see and hear you. If the beast''s Intelligence is 4 or higher, the power fails. Otherwise, the beast must succeed on a Sense saving throw (DC = 8 + your proficiency bonus + your spellcasting ability modifier) or be charmed by you for the power''s duration.', false, false, 'Enchantment', 'V, S, M', ARRAY[], ARRAY['charm', 'beast'], 'SRD', 'srd', '5e SRD', 'Open Game License content'),
...
('Burning Hands', 1, '1 action', 'Self (15-foot cone)', 'Instantaneous', 'As you hold your hands with thumbs touching and fingers spread, a thin sheet of flames shoots forth from your outstretched fingertips. Each creature in a 15-foot cone must make an Agility saving throw (DC = 8 + your proficiency bonus + your spellcasting ability modifier). A creature takes 3d6 fire damage on a failed save, or half as much damage on a successful one.', false, false, 'Evocation', 'V, S', ARRAY[], ARRAY['damage', 'fire'], 'SRD', 'srd', '5e SRD', 'Open Game License content'),
...
('Compelled Duel', 1, '1 bonus action', '30 feet', 'Concentration, up to 1 minute', 'You attempt to compel a creature into a duel. One creature that you can see within range must make a Sense saving throw (DC = 8 + your proficiency bonus + your spellcasting ability modifier). On a failed save, the creature is drawn to you, compelled by your divine demand. For the duration, it has disadvantage on attack rolls against creatures other than you, and must make a Sense saving throw (DC = 8 + your proficiency bonus + your spellcasting ability modifier) each time it attempts to move to a space that is more than 30 feet away from you.', true, false, 'Enchantment', 'V', ARRAY[], ARRAY['control', 'tank'], 'SRD', 'srd', '5e SRD', 'Open Game License content'),
...
('Faerie Fire', 1, '1 action', '60 feet', 'Concentration, up to 1 minute', 'Each object in a 20-foot cube within range is outlined in blue, green, or violet light (your choice). Any creature in the area when the power is cast is also outlined in light if it fails an Agility saving throw (DC = 8 + your proficiency bonus + your spellcasting ability modifier). For the duration, objects and affected creatures shed dim light in a 10-foot radius.', true, false, 'Evocation', 'V', ARRAY[], ARRAY['utility'], 'SRD', 'srd', '5e SRD', 'Open Game License content'),
