...
function getPromptForType(type: string, batchSize: number, batchMinified: string) {
...
async function processFile(filePath: string, exportName: string, type: string, header: string) {
            ...
            for (const item of chunk) {
                ...
                if (generated) {
                    ...
                    if (type === "sigils") {
                        ...
                        if (Array.isArray(generated.expert)) item.benefits.expert = generated.expert;
                        if (Array.isArray(generated.master)) item.benefits.master = generated.master;
                    } else if (type === "runes") {
