...
export const THEMES = [
	...
	},
	{
		...
		ridersConsumable: [
			"Restores 1d4 cold damage. Grants resistance to fire damage for 1 minute.",
		],
	},
	{
		match:
			/\b(Crimson|Bleeding|Sanguine|Bloody|Bloodborne|Bloodied|Hemo|Crimsonback)\b/i,
		key: "crimson",
		damageType: "slashing",
		...
		ridersConsumable: [
			"Restores HP and grants advantage on Vitality saves for 1 minute.",
		],
	},
	{
		match:
	...
	{
		match:
			/\b(Starlight|Celestial|Dawn|Solar|Radiant|Sunblessed|Aurora|Lumen)\b/i,
		key: "starlight",
		damageType: "radiant",
		consumableSubtype: "healing",
		ridersWeapon: [
		...
		ridersConsumable: [
			"Cures one of: blinded, charmed, frightened. Grants 1d6 temporary HP.",
		],
	},
	{
		match:
			/\b(Shadow|Umbral|Dark|Obsidian|Nightfall|Eclipsed|Twilight|Penumbra)\b/i,
		key: "shadow",
		damageType: "necrotic",
	...
	{
		match:
			/\b(Storm|Lightning|Thunder|Tempest|Voltage|Galvanic|Stormcaller)\b/i,
		key: "storm",
		...
		ridersArmor: [
			...
			"Once per long rest, when struck by lightning, regain HP equal to half the damage taken instead.",
		],
		ridersConsumable: [
			"Grants resistance to lightning damage and advantage on Agility saves for 1 minute.",
		],
	},
	{
		match:
			/\b(Flame|Fire|Inferno|Burning|Pyre|Ember|Cinder|Wildfire|Searing)\b/i,
		key: "flame",
		damageType: "fire",
		ridersWeapon: [
		...
		ridersArmor: [
			...
			"Cannot be set on fire by mundane sources.",
		],
		ridersConsumable: [
			"Cures the burning condition. Grants resistance to fire damage for 1 minute.",
		],
	},
	{
		match:
			/\b(Toxic|Venomous|Venom|Acid|Corrosive|Caustic|Vitriol|Necrotoxic)\b/i,
		key: "toxic",
		damageType: "acid",
		consumableSubtype: "healing",
		ridersWeapon: [
		...
		ridersArmor: [
			...
			"Once per long rest, neutralize an active poison effect on you.",
		],
		ridersConsumable: [
			"Cures the poisoned condition and removes 1d4 ongoing damage.",
		],
	},
	{
		match:
			/\b(Rift|Dimensional|Gateforged|Gatebound|Tear|Riftborn|Riftbound|Riftforged)\b/i,
		key: "rift",
		damageType: "force",
		ridersWeapon: [
		...
		ridersArmor: [
			"Once per long rest, when an attack would hit you, you may rift-shift 5 ft.; the attack is rerolled against the new position.",
		],
		ridersConsumable: [
			"Grants the ability to teleport up to 30 ft. as a bonus action (1 use).",
		],
	},
	{
		match:
			/\b(Holy|Sacred|Blessed|Sanctified|Hallowed|Divine|Pious|Consecrated)\b/i,
		key: "holy",
		damageType: "radiant",
		consumableSubtype: "healing",
		ridersWeapon: [
		...
		ridersConsumable: [
			"Cures Frightened, Charmed, or Lattice-Bled conditions. Grants 1d6 temporary HP.",
		],
	},
	{
		...
		ridersArmor: [
			"Cursed: cannot be voluntarily removed once attuned. While attuned, +1 AC.",
		],
		ridersConsumable: [
			"Inflicts a chosen 1-minute curse on a touched creature on a failed DC 13 Vitality save.",
		],
		cursed: true,
	},
];
...
const VARIANT_POOLS = {
	...
	firearm_pistol: [
		{
			damage: "1d8",
			damageType: "piercing",
			props: ["ammunition", "light"],
			range: "Ranged (40/120)",
			note: "Sidearm. Reload (1) on a bonus action.",
		},
		{
			damage: "1d6",
			damageType: "piercing",
			props: ["ammunition", "light", "finesse"],
			range: "Ranged (50/150)",
			note: "Snub-frame. Counts as a finesse weapon.",
		},
		{
			damage: "1d10",
			damageType: "piercing",
			props: ["ammunition"],
			range: "Ranged (40/120)",
			note: "Magnum-frame. -1 to attack within 5 ft.",
		},
		{
			damage: "1d8",
			damageType: "piercing",
			props: ["ammunition", "light", "silent"],
			range: "Ranged (30/90)",
			note: "Suppressed. Doesn't reveal your position when fired.",
		},
	],
	firearm_rifle: [
		{
			...
			range: "Ranged (80/240)",
			note: "Long-arm. Disadvantage on attacks within 5 ft.",
		},
		{
			damage: "1d12",
			damageType: "piercing",
			props: ["ammunition", "two-handed", "loading"],
			range: "Ranged (100/400)",
			note: "Bolt-action. One attack per turn; +1 to attack rolls.",
		},
		{
			damage: "2d6",
			damageType: "piercing",
			props: ["ammunition", "two-handed", "heavy"],
			range: "Ranged (80/240)",
			note: "Marksman variant. Crit on 19-20.",
		},
		{
			damage: "1d8",
			damageType: "piercing",
			props: ["ammunition", "two-handed", "burst-fire"],
			range: "Ranged (60/180)",
			note: "Auto-rifle. Burst-fire (3 rd, +1d6) on a single attack.",
		},
	],
	firearm_shotgun: [
		{
			...
			props: ["ammunition", "two-handed", "loading"],
			range: "Ranged (15/60)",
			note: "Spread shot. Loading: one attack per turn.",
		},
		{
			damage: "1d10",
			damageType: "piercing",
			props: ["ammunition", "two-handed", "burst-fire"],
			range: "Ranged (15/45)",
			note: "Auto-shotgun. Burst-fire (3 rd, +1d6).",
		},
		{
			damage: "3d4",
			damageType: "piercing",
			props: ["ammunition", "two-handed"],
			range: "Ranged (10/30)",
			note: "Sawed-off. Each attack hits up to 2 adjacent targets.",
		},
	],
	firearm_smg: [
		{
			damage: "1d6",
			damageType: "piercing",
			props: ["ammunition", "light", "burst-fire"],
			range: "Ranged (40/120)",
			note: "Burst fire (3 rd, +1d6 damage on hit).",
		},
		{
			damage: "1d4",
			damageType: "piercing",
			props: ["ammunition", "light", "automatic"],
			range: "Ranged (30/90)",
			note: "Automatic. Suppressing fire imposes -2 to enemy attacks in a 15-ft. cone.",
		},
	],
	firearm_launcher: [
		{
			damage: "3d6",
			damageType: "force",
			props: ["ammunition", "two-handed", "heavy", "loading"],
			range: "Ranged (60/180)",
			note: "AoE: 10 ft. radius. DC 13 Agility save halves damage.",
		},
		{
			damage: "2d8",
			damageType: "fire",
			props: ["ammunition", "two-handed", "heavy", "loading"],
			range: "Ranged (40/120)",
			note: "Incendiary. AoE 10 ft.: ignites flammable objects on a fail.",
		},
	],
	...
	melee_blade_finesse: [
		...
		},
		{
			...
			damageType: "slashing",
			props: ["light", "finesse"],
			note: "+1 to attack rolls when you have advantage.",
		},
	],
	melee_blade_versatile: [
		...
		},
		{
			...
			damageType: "piercing",
			props: ["versatile (1d10)"],
			note: "Counts as both slashing and piercing for resistance bypass.",
		},
		{
			damage: "1d10",
			damageType: "slashing",
			props: ["versatile (1d12)", "two-handed-bonus"],
			note: "When wielded two-handed, +1 to damage rolls.",
		},
	],
	melee_blade_heavy: [
		{
		...
		},
		{
			...
			damageType: "slashing",
			props: ["heavy", "two-handed"],
			note: "On a critical hit, deal an additional 2d6 damage.",
		},
		{
			damage: "2d8",
			damageType: "slashing",
			props: ["heavy", "two-handed", "loading"],
			note: "Slow swing: this weapon attacks last in initiative; deals double damage on a critical hit.",
		},
	],
	melee_polearm: [
		{
			...
			note: "Reach: melee attacks have 10 ft. range.",
		},
		{
			damage: "1d8",
			damageType: "slashing",
			props: ["heavy", "reach", "two-handed"],
			note: "Reach. On a hit, you may use a reaction to make an opportunity attack against a creature within 10 ft.",
		},
		{
			damage: "2d4",
			damageType: "piercing",
	...
	melee_bludgeon: [
		...
		},
		{
			...
			damageType: "bludgeoning",
			props: ["versatile (1d10)"],
			note: "On a hit, target makes a DC 11 Strength save or has disadvantage on its next attack.",
		},
		{
			damage: "1d6",
			damageType: "bludgeoning",
	...
	melee_bludgeon_heavy: [
		{
			...
			damageType: "bludgeoning",
			props: ["heavy", "two-handed"],
			note: "On a hit, target makes a DC 13 Strength save or is knocked prone.",
		},
		{
			damage: "2d6",
			damageType: "bludgeoning",
			props: ["heavy", "two-handed", "loading"],
			note: "Slow swing. On hit, deal +1 damage per 2 levels of the wielder.",
		},
		{
			damage: "1d12",
			damageType: "bludgeoning",
			props: ["heavy", "two-handed"],
			note: "Crit on 19-20. Critical hits push target 5 ft.",
		},
	],
	melee_staff: [
		{
			...
			damageType: "bludgeoning",
			props: ["versatile (1d8)"],
			note: "Doubles as an arcane focus.",
		},
		{
			damage: "1d4",
			damageType: "bludgeoning",
			props: ["versatile (1d6)", "light"],
			note: "Doubles as an arcane focus. +1 to spell-save DCs while wielded.",
		},
		{
			damage: "1d8",
			damageType: "bludgeoning",
			props: ["versatile (1d10)", "two-handed-bonus"],
			note: "Quarterstaff variant. Counts as a martial Striker weapon.",
		},
	],
	...
	melee_gauntlet: [
		{
			...
			damageType: "bludgeoning",
			props: ["light", "striker"],
			note: "Counts as an unarmed strike for Striker class features.",
		},
		{
			damage: "1d6",
			damageType: "bludgeoning",
			props: ["light", "striker"],
			note: "Counts as an unarmed strike. On a hit, target makes a DC 11 Strength save or is grappled.",
		},
		{
			damage: "1d6",
			damageType: "slashing",
			props: ["light", "finesse", "striker"],
			note: "Bladed knuckles. Finesse.",
		},
		{
			damage: "1d4",
			damageType: "force",
			props: ["light", "striker", "arcane focus"],
			note: "Aether-knuckles. Counts as an arcane focus and a Striker weapon.",
		},
	],
	melee_whip: [
		{
		...
		},
		{
			...
			damageType: "slashing",
			props: ["finesse", "reach"],
			note: "Reach. On a hit, target makes a DC 11 Agility save or is pulled 5 ft. toward you.",
		},
		{
			damage: "1d4",
			damageType: "bludgeoning",
			props: ["finesse", "reach"],
			note: "Reach. On a hit, target makes a DC 11 Strength save or is disarmed.",
		},
	],
	melee_axe: [
		{
	...
	melee_sickle: [
		{ damage: "1d4", damageType: "slashing", props: ["light"], note: "" },
		{
			...
			damageType: "slashing",
			props: ["light", "finesse"],
			note: "Finesse. +1 damage when target is below half HP.",
		},
	],
	...
	ranged_bow: [
		...
		},
		{
			damage: "1d6",
			damageType: "piercing",
			props: ["ammunition", "two-handed", "silent"],
			range: "Ranged (80/320)",
			note: "Silent. Doesn't reveal your position when fired.",
		},
		{
			damage: "1d10",
			damageType: "piercing",
			...
			note: "Bolt-action longbow variant. One attack per turn; +1 to attack rolls.",
		},
	],
	ranged_crossbow: [
		{
		...
		},
		{
			...
			props: ["ammunition", "two-handed"],
			range: "Ranged (60/180)",
			note: "Repeater. No loading; can attack twice per turn at -2 to attack rolls.",
		},
	],
	ranged_thrown: [
		{
	...
	focus_caster: [
		{
			note: "Acts as an arcane focus. +1 to spell attack rolls.",
			item_type: "tool",
			type: "focus",
		},
		{
			note: "Acts as an arcane focus. Once per long rest, regain 1 spell slot of 3rd level or lower.",
			item_type: "tool",
			type: "focus",
		},
		{
			note: "Acts as an arcane focus. Spells cast through this focus add +1 to damage or healing rolls.",
			item_type: "tool",
			type: "focus",
		},
	],
	focus_wand: [
		{
			...
			props: ["arcane focus"],
			range: "Ranged (60/180)",
			note: "Acts as an arcane focus.",
		},
		{
			damage: "1d4",
			damageType: "force",
			props: ["arcane focus", "light"],
			range: "Ranged (30/90)",
			note: "Acts as an arcane focus. Once per short rest, cast a known cantrip without expending an action.",
		},
		{
			damage: "1d8",
			damageType: "force",
			props: ["arcane focus", "loading"],
			range: "Ranged (60/180)",
			note: "Acts as an arcane focus. Loading: one attack per turn; deals +1 force damage on a hit.",
		},
	],
	focus_tome: [
		{
			note: "Acts as a written arcane focus.",
			item_type: "tool",
			type: "scroll",
		},
		{
			note: "Acts as a written arcane focus. While attuned, gain a +1 bonus to one spell-attack or spell-save DC of your choice.",
			item_type: "tool",
			type: "scroll",
		},
		{
	...
	armor_light: [
		{
			ac: 11,
			type: "Light",
			note: "Light, flexible armor weave. Standard kit for fast movers.",
		},
		{ ac: 12, type: "Light", note: "Reinforced light armor. AC 12 + AGI." },
		{
			ac: 11,
			type: "Light",
			note: "Stealth-treated armor. Advantage on Stealth checks while worn.",
		},
		{
			ac: 12,
			type: "Light",
			note: "Mana-stable weave. Resistance to a chosen damage type while attuned.",
		},
	],
	armor_medium: [
		{ ac: 13, type: "Medium", note: "Layered scale-and-cloth composite." },
		{
			ac: 14,
			type: "Medium",
			note: "Reinforced medium armor with Bureau-stamped joints.",
		},
		{
			ac: 13,
			type: "Medium",
			note: "Mana-treated scale armor. Resistance to one chosen damage type.",
		},
	],
	armor_heavy: [
		{
			...
			stealthDisadv: true,
			strReq: 13,
			note: "Standard heavy plate. Stealth disadvantage.",
		},
		{
			ac: 16,
			type: "Heavy",
			stealthDisadv: true,
			strReq: 13,
			note: "Reinforced carapace. AC 16. Stealth disadvantage.",
		},
		{
			ac: 17,
			type: "Heavy",
			stealthDisadv: true,
			strReq: 15,
			note: "Heavy carapace plating. AC 17. Stealth disadvantage. Requires STR 15.",
		},
		{
			ac: 16,
			type: "Heavy",
			stealthDisadv: true,
			strReq: 13,
			note: "Mana-stable plate. Resistance to force damage.",
		},
	],
	armor_shield: [
		...
		{
			acBonus: 2,
			note: "Tower shield. +2 AC. Provides three-quarter cover when set as an action.",
		},
		{
			acBonus: 2,
			note: "Buckler. +2 AC. Counts as a free hand for casting somatic components.",
		},
	],
	armor_headgear: [
	...
	consumable_potion: [
		...
		{
			subtype: "fortifying",
			note: "Grants 5 + Vitality temporary HP for 10 minutes.",
			action: "Drink",
		},
		{
			subtype: "berserker",
			note: "Advantage on attack rolls for 1 minute. After, gain one level of exhaustion.",
			action: "Drink",
		},
	],
	consumable_stim: [
		...
		{
			subtype: "combat",
			note: "Grants advantage on the next attack roll within 1 minute. After, take 1 fatigue.",
			action: "Inject",
		},
		{
			subtype: "endurance",
			note: "Grants resistance to non-magical bludgeoning, piercing, and slashing for 1 minute.",
			action: "Inject",
		},
		{
			subtype: "focus",
			note: "Grants advantage on Investigation, Insight, and Sense saves for 10 minutes.",
			action: "Inject",
		},
	],
	consumable_grenade: [
		{
			subtype: "force",
			damage: { c: "2d6", u: "3d6", r: "4d6", e: "5d6", l: "6d6" },
			damageType: "force",
			radius: 10,
			note: "Detonates in a 10-ft. radius. DC 13 Agility save halves damage.",
		},
		{
			subtype: "fire",
			damage: { c: "2d6", u: "3d6", r: "4d6", e: "5d6", l: "6d6" },
			damageType: "fire",
			radius: 10,
			note: "Incendiary. Targets that fail a DC 13 Agility save are also Burning (1d4/turn).",
		},
		{
			subtype: "shock",
			damage: { c: "2d4", u: "3d4", r: "4d4", e: "5d4", l: "6d4" },
			damageType: "lightning",
			radius: 5,
			note: "EMP variant. Disables electronics and stuns mechanical anomalies for 1 round on a fail.",
		},
		{
			subtype: "smoke",
			damage: null,
			damageType: null,
			radius: 20,
			note: "Heavy obscurement in 20-ft. radius for 1 minute. No damage.",
		},
	],
	consumable_scroll: [
		{
			subtype: "attack",
			note: "Single-use scroll. Casts an inscribed offensive spell at rank-appropriate potency. Consumes the scroll.",
		},
		{
			subtype: "utility",
			note: "Single-use scroll. Casts an inscribed utility spell. Consumes the scroll.",
		},
		{
			subtype: "buff",
			note: "Single-use scroll. Casts an inscribed buff spell. Consumes the scroll.",
		},
	],
	consumable_purifier: [
		{
			subtype: "antidote",
			note: "Cures the poisoned condition.",
			action: "Apply",
		},
		{
			subtype: "panacea",
			note: "Cures one of: charmed, frightened, poisoned, weakened.",
			action: "Apply",
		},
		{
			subtype: "mana cleanser",
			note: "Cures one mana-class condition (mana-burn, lattice-bleed, channel-lock).",
			action: "Apply",
		},
	],
	consumable_signal: [
	...
	consumable_ration: [
		{ note: "A day's nutrition for one Hunter on a cleared sweep." },
	],
...
const UNIQUE_ACTIVES = {
	...
	epic: [
		{
			name: "Aetheric Burst",
			description:
				"As an action, all creatures within 10 ft. make a DC 14 Agility save, taking 4d6 force damage on a fail (half on success).",
			action: "action",
			frequency: "short-rest",
			dc: 14,
		},
		{
			...
			description:
				"As a reaction to being hit by an attack, halve the damage taken; the attacker takes the halved amount as force damage.",
			action: "reaction",
			frequency: "short-rest",
		},
		{
			name: "Shadow Step",
			description:
				"As a bonus action, teleport up to 60 ft. and gain advantage on the next attack roll you make before the end of this turn.",
			action: "bonus-action",
			frequency: "short-rest",
		},
		{
			name: "Bind Anomaly",
			description:
				"As an action, target one Anomaly within 30 ft. It must make a DC 14 Sense save or be Restrained for 1 minute (saves at end of each of its turns).",
			action: "action",
			frequency: "long-rest",
			dc: 14,
		},
		{
			name: "Echo Strike",
			description:
				"As a bonus action, when you hit with a weapon attack, repeat the attack against the same target with no additional roll. Apply only the damage die.",
			action: "bonus-action",
			frequency: "short-rest",
		},
		{
	...
	legendary: [
		{
			name: "Anomaly Disruption",
			description:
				"As an action, all creatures within 30 ft. make a DC 16 Vitality save, taking 6d6 force damage on a fail (half on success).",
			action: "action",
			frequency: "long-rest",
			dc: 16,
		},
		{
			name: "Time Slip",
			description: "As a bonus action, take an extra action on this turn.",
			action: "bonus-action",
			frequency: "long-rest",
		},
		{
			name: "Resurrection Echo",
			description:
				"As a reaction when you would drop to 0 HP, drop to 1 HP and become invulnerable until the end of your next turn.",
			action: "reaction",
			frequency: "long-rest",
		},
		{
			name: "Reality Cut",
			description:
				"As an action, make one weapon attack against any creature within 60 ft.; the attack ignores cover and damage resistance.",
			action: "action",
			frequency: "long-rest",
		},
		{
			name: "Apex Surge",
			description:
				"As a bonus action for 1 minute, your weapon attacks gain advantage and crit on 18-20.",
			action: "bonus-action",
			frequency: "long-rest",
		},
		{
			...
			description:
				"As an action, all hostile creatures within 60 ft. make a DC 17 Vitality save or take 8d6 damage of this item's theme type and are Stunned until the end of their next turn.",
			action: "action",
			frequency: "long-rest",
			dc: 17,
		},
