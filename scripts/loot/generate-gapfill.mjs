...
function weightFor(archetype) {
	...
	if (archetype.startsWith("armor_light") || archetype === "armor_headgear")
		return 8;
	if (archetype === "armor_shield") return 6;
	if (archetype.startsWith("firearm_"))
		return (
			4 +
			(archetype.includes("rifle") || archetype.includes("launcher") ? 4 : 0)
		);
	if (archetype.startsWith("melee_"))
		return archetype.includes("heavy") ? 8 : 3;
	if (archetype.startsWith("ranged_"))
		return archetype.includes("crossbow") ? 6 : 2;
	if (archetype === "focus_tome") return 5;
	if (archetype.startsWith("focus_")) return 1;
	if (archetype.startsWith("consumable_"))
		return archetype.includes("grenade") ? 1 : 0.5;
	return 1;
}
...
const NOUNS_BY_ARCHETYPE = {
	...
	firearm_smg: ["SMG", "Submachine Gun", "PDW", "Compact SMG", "Auto-SMG"],
	firearm_launcher: [
		"Launcher",
		"Grenade Launcher",
		"Rocket Launcher",
...
const TARGETS = [
	// === Wondrous gear: heavy DDB depth (rings/amulets/belts/boots/cloaks have huge magic catalogs) ===
	{
		...
		counts: { common: 8, uncommon: 14, rare: 14, epic: 8, legendary: 4 },
	},
	{
		archetype: "gear_ring",
		counts: { common: 8, uncommon: 18, rare: 18, epic: 10, legendary: 4 },
	},
	{
		archetype: "gear_belt",
		counts: { common: 6, uncommon: 10, rare: 8, epic: 4, legendary: 2 },
	},
	{
		archetype: "gear_boots",
		counts: { common: 6, uncommon: 10, rare: 8, epic: 4, legendary: 2 },
	},
	{
		archetype: "gear_attire",
		counts: { common: 6, uncommon: 12, rare: 10, epic: 5, legendary: 2 },
	},
	{
		archetype: "gear_bracer",
		counts: { common: 4, uncommon: 8, rare: 6, epic: 3 },
	},
	...
	{ archetype: "gear_kit", counts: { common: 5, uncommon: 4, rare: 2 } },
	{
		...
		counts: { common: 5, uncommon: 5, rare: 3, epic: 1 },
	},
	...
	{
		archetype: "consumable_grenade",
		counts: { common: 6, uncommon: 8, rare: 6, epic: 3, legendary: 1 },
	},
	{
		archetype: "consumable_signal",
		counts: { common: 5, uncommon: 3, rare: 1 },
	},
	{
		archetype: "consumable_scroll",
		counts: { common: 10, uncommon: 18, rare: 18, epic: 10, legendary: 4 },
	},
	{ archetype: "consumable_ration", counts: { common: 6, uncommon: 2 } },
	{
		archetype: "consumable_potion",
		counts: { common: 4, uncommon: 6, rare: 6, epic: 3, legendary: 1 },
	},
	{
		archetype: "consumable_purifier",
		counts: { common: 4, uncommon: 4, rare: 2 },
	},
	{
		archetype: "consumable_stim",
		counts: { common: 4, uncommon: 6, rare: 4, epic: 2 },
	},

	// === Foci (DDB has wand of fireball, staff of power, etc. — many entries) ===
	{
		archetype: "focus_caster",
		counts: { common: 4, uncommon: 6, rare: 5, epic: 3, legendary: 1 },
	},
	{
		archetype: "focus_wand",
		counts: { common: 4, uncommon: 8, rare: 8, epic: 4, legendary: 2 },
	},
	{
		archetype: "focus_tome",
		counts: { common: 4, uncommon: 6, rare: 5, epic: 2, legendary: 1 },
	},
	...
	// === Melee weapons (each weapon class gets ~15-25 entries to mirror DDB +1/+2/+3 spread) ===
	{
		...
		counts: { common: 4, uncommon: 8, rare: 6, epic: 3, legendary: 1 },
	},
	{
		archetype: "melee_blade_versatile",
		counts: { common: 3, uncommon: 4, rare: 3, epic: 2, legendary: 1 },
	},
	{
	...
	},
	{
		...
		counts: { common: 2, uncommon: 3, rare: 3, epic: 1 },
	},
	{
		archetype: "melee_bludgeon",
		counts: { common: 5, uncommon: 6, rare: 5, epic: 2, legendary: 1 },
	},
	{
	...
	},
	{
		...
		counts: { common: 2, uncommon: 3, rare: 2, epic: 1 },
	},
	{
		archetype: "melee_axe",
		counts: { common: 4, uncommon: 6, rare: 5, epic: 2, legendary: 1 },
	...
	// === Armor ===
	{
		...
		counts: { common: 2, uncommon: 4, rare: 3, epic: 1, legendary: 1 },
	},
	{
	...
	},
	{
		...
		counts: { common: 2, uncommon: 4, rare: 3, epic: 2, legendary: 1 },
	},
	{
	...
	},
	{
		...
		counts: { common: 3, uncommon: 5, rare: 4, epic: 2, legendary: 1 },
	},
	...
	},
	{
		...
		counts: { common: 4, uncommon: 6, rare: 4, epic: 2, legendary: 1 },
	},
	{
		archetype: "firearm_shotgun",
		counts: { common: 4, uncommon: 5, rare: 3, epic: 1 },
	},
	{
		archetype: "firearm_smg",
		counts: { common: 4, uncommon: 4, rare: 3, epic: 1 },
	},
	{
		archetype: "firearm_launcher",
		counts: { common: 2, uncommon: 3, rare: 2, epic: 1 },
	},
];
	...
	for (const target of TARGETS) {
		...
		for (const rarity of ["common", "uncommon", "rare", "epic", "legendary"]) {
			...
			while (placed < n && idx < combos.length * 4) {
				...
				if (cycle > 0) {
					const mark =
						["Mk II", "Mk III", "Mk IV"][cycle - 1] || `Mk ${cycle + 1}`;
					name = `${adj} ${noun} ${mark}`;
				}
				idx += 1;
...
function ensureRegisteredInIndex() {
	...
	if (!existsSync(indexPath)) {
		console.warn(
			`! items-index.ts not found at ${indexPath}; skipping registration`,
		);
		return;
	}
	...
	console.warn(
		"! items-gap-fill not registered in items-index.ts. Manual edit recommended (see README at top of generated file).",
	);
}
