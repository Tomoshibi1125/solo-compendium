...
console.log('Spells:', spN.length + rdN.length, '(sup:', spN.length, '+ rank-d:', rdN.length + ')');
console.log('Powers:', pwN.length + pcN.length, '(sup:', pwN.length, '+ core:', pcN.length + ')');
console.log('Techniques:', tcN.length + tccN.length, '(sup:', tcN.length, '+ core:', tccN.length + ')');
