...
const HOOKS_PATH =
	"c:/Users/jjcal/Documents/solo-compendium/src/hooks/useRunes.ts";
...
function refactorLogic() {
	...
	const checkRunePattern =
		/\/\/ Check if character meets rune requirements\s*export function checkRuneRequirements\([\s\S]*?}[\s\S]*?}/;
